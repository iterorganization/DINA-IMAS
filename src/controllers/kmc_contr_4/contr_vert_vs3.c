 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Mon Jul 25 10:43:07 2022
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME contr_vert_vs3
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void contr_vert_vs3_Outputs_wrapper(const real_T *u0,
                          real_T *y0 ,
			      const real_T  *xD,
                          const real_T  *n_in, const int_T  p_width0, 
                          const real_T  *n_out, const int_T  p_width1, 
                          const real_T  *k_hl, const int_T p_width2);
extern void contr_vert_vs3_Update_wrapper(const real_T *u0,
                          const real_T *y0 ,
                          real_T *xD, 
                          const real_T  *n_in,  const int_T  p_width0,
                          const real_T  *n_out,  const int_T  p_width1,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T  *k_hl  = (const real_T *)mxGetData(PARAM_DEF2(S));

    contr_vert_vs3_Outputs_wrapper(u0, y0, xD, n_in, p_width0, n_out, p_width1, k_hl, p_width2);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    contr_vert_vs3_Update_wrapper(u0, y0,  xD, n_in, p_width0, n_out, p_width1, k_hl, p_width2);
}
