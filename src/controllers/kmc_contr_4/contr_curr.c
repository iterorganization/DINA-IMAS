 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Mon Jul 25 10:46:34 2022
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME contr_curr
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    contr_curr_Outputs_wrapper(u0, y0, xD, n_in, p_width0, n_out, p_width1, k_hl, p_width2);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    contr_curr_Update_wrapper(u0, y0,  xD, n_in, p_width0, n_out, p_width1, k_hl, p_width2);
}
