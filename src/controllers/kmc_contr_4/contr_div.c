 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Mon Jul 25 10:46:54 2022
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME contr_div
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    contr_div_Outputs_wrapper(u0, y0, xD, n_in, p_width0, n_out, p_width1, k_hl, p_width2);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    contr_div_Update_wrapper(u0, y0,  xD, n_in, p_width0, n_out, p_width1, k_hl, p_width2);
}
