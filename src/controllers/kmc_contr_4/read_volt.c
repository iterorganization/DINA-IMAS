...
#define S_FUNCTION_NAME read_volt
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void read_volt_Outputs_wrapper(real_T *y0, 
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    read_volt_Outputs_wrapper(y0, n_mc, p_width0, S);
}
