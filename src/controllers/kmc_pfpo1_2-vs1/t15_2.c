...
void t15_2_step(void)
{
   ...
   */
  t15_2_B.Sum2 = t15_2_B.Ip1e4 + t15_2_P.Constant4_Value_l;

  /* RelationalOperator: '<S5>/Relational Operator' */
  t15_2_B.RelationalOperator_p = (t15_2_B.Times >= t15_2_B.Sum2);

  /* Stop: '<S5>/Stop Simulation' */
  if (t15_2_B.RelationalOperator_p) {
  ...
  t15_2_B.RelationalOperator1_or = (t15_2_B.Times >= t15_2_B.DataStoreRead1);

  /* Stop: '<S5>/Stop Simulation1' */
  if (t15_2_B.RelationalOperator1_or) {
    rtmSetStopRequested(t15_2_M, 1);
  }
   ...
   */
  for (i = 0; i < 15; i++) {
    t15_2_B.e6_h[i] = t15_2_U.In2[i + 6] * t15_2_P.e6_Gain_d;
  }
  ...
  t15_2_B.DataStoreRead1_f = t15_2_DWork.RupRd[4];

  /* Gain: '<S18>/1e-3' */
  t15_2_B.e3 = t15_2_P.e3_Gain * t15_2_B.DataStoreRead1_f;
  ...
  t15_2_B.RelationalOperator = (t15_2_B.e6_h[2] < t15_2_B.Product1);
   ...
   */
  t15_2_B.Add1 = t15_2_B.Product + t15_2_P.Constant4_Value_e;
  ...
  /* Memory: '<S19>/Memory1' */
  t15_2_B.Memory1_h = t15_2_DWork.Memory1_PreviousInput_d;

  /* Switch: '<S19>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_d) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S19>/Data Store Read1' */
      t15_2_B.DataStoreRead1_jw[i] = t15_2_DWork.scr_data[13 * i + 1];

      /* DataStoreRead: '<S19>/Data Store Read' */
      t15_2_B.DataStoreRead_ow[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.Ipref), &t15_2_B.DataStoreRead1_jw[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_ow[0], 499U);
  ...
  /* Product: '<S19>/Divide6' */
  t15_2_B.Divide6 = t15_2_B.c_eob * t15_2_B.u_c;
  ...
  if (t15_2_B.u_c >= t15_2_P.c_eob1_Threshold) {
    for (i = 0; i < 50; i++) {
      ...
      t15_2_B.Selector_i[i] = t15_2_B.SFunction1_m[(i << 1) + 1];

      /* Selector: '<S44>/Selector1' */
      t15_2_B.Selector1_ob[i] = t15_2_B.SFunction1_m[i << 1];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g1ref), &t15_2_B.Selector_i[0],
                         t15_2_B.Times, &t15_2_B.Selector1_ob[0], 49U);
    t15_2_B.c_eob1 = t15_2_B.g1ref;
  } else {
    t15_2_B.c_eob1 = t15_2_B.Memory2_m;
  }
  ...
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_h) {
    ...
    t15_2_B.c_eob_n = t15_2_B.Memory1_j;
  }
  ...
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_g) {
    ...
    for (i = 0; i < 49; i++) {
      ...
      t15_2_B.Selector_o[i] = t15_2_B.SFunction1_l[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg1_termref[i + 1] = t15_2_B.Selector_o[i];
    }

    /* End of SignalConversion: '<S50>/TmpSignal ConversionAtg1_term,refInport3' */

    /* DataStoreRead: '<S50>/Data Store Read1' */
    t15_2_B.DataStoreRead1_ii = t15_2_DWork.trd_ref;

    /* DataStoreRead: '<S50>/Data Store Read' */
    t15_2_B.DataStoreRead_mr = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S50>/Selector1' */
      t15_2_B.Selector1_o[i] = t15_2_B.SFunction1_l[i << 1];

      /* Product: '<S50>/Divide6' */
      t15_2_B.Divide6_m[i] = t15_2_B.Selector1_o[i] * t15_2_B.DataStoreRead_mr /
        t15_2_B.DataStoreRead1_ii;

      /* Sum: '<S50>/Add2' */
      t15_2_B.Add2_o[i] = t15_2_B.c_eob_n + t15_2_B.Divide6_m[i];
    }
  ...
  /* Sum: '<S23>/Add2' */
  t15_2_B.Add2_p = t15_2_B.e2[0] - t15_2_B.c_eob_c;
  ...
  /* Memory: '<S40>/Memory2' */
  t15_2_B.Memory2_a = t15_2_DWork.Memory2_PreviousInput_mc;

  /* Switch: '<S40>/c_eob  1' */
  if (t15_2_B.u_c >= t15_2_P.c_eob1_Threshold_a) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S40>/Selector' */
      t15_2_B.Selector_e[i] = t15_2_B.SFunction1_e[(i << 1) + 1];

      /* Selector: '<S40>/Selector1' */
      t15_2_B.Selector1_a[i] = t15_2_B.SFunction1_e[i << 1];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g2ref), &t15_2_B.Selector_e[0],
                         t15_2_B.Times, &t15_2_B.Selector1_a[0], 49U);
    t15_2_B.c_eob1_j = t15_2_B.g2ref;
  } else {
    t15_2_B.c_eob1_j = t15_2_B.Memory2_a;
  }
  ...
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_l) {
    ...
    t15_2_B.c_eob_a = t15_2_B.Memory1_k;
  }
  ...
  /* Switch: '<S40>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_j) {
    t15_2_B.c_eob_j = t15_2_B.c_eob1_j;
  } else {
    ...
    for (i = 0; i < 49; i++) {
      ...
      t15_2_B.Selector_p[i] = t15_2_B.SFunction1_l4[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg2_termref[i + 1] = t15_2_B.Selector_p[i];
    }

    /* End of SignalConversion: '<S46>/TmpSignal ConversionAtg2_term,refInport3' */

    /* DataStoreRead: '<S46>/Data Store Read1' */
    t15_2_B.DataStoreRead1_el = t15_2_DWork.trd_ref;

    /* DataStoreRead: '<S46>/Data Store Read' */
    t15_2_B.DataStoreRead_f0 = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S46>/Selector1' */
      t15_2_B.Selector1_k[i] = t15_2_B.SFunction1_l4[i << 1];

      /* Product: '<S46>/Divide6' */
      t15_2_B.Divide6_a[i] = t15_2_B.Selector1_k[i] * t15_2_B.DataStoreRead_f0 /
        t15_2_B.DataStoreRead1_el;

      /* Sum: '<S46>/Add2' */
      t15_2_B.Add2_hb[i] = t15_2_B.c_eob_a + t15_2_B.Divide6_a[i];
    }
    ...
    LookUp_real_T_real_T( &(t15_2_B.g2_termref),
                         ...
                         t15_2_B.Times, &t15_2_B.Add2_hb[0], 49U);
  ...
  /* Sum: '<S23>/Add1' */
  t15_2_B.Add1_g = t15_2_B.e2[1] - t15_2_B.c_eob_j;

  /* DataStoreRead: '<S23>/Data Store Read1' */
  t15_2_B.DataStoreRead1_n = t15_2_DWork.RupRd[3];

  /* RelationalOperator: '<S23>/Relational Operator2' */
  t15_2_B.RelationalOperator2 = (t15_2_B.Times < t15_2_B.DataStoreRead1_n);
  ...
  /* Memory: '<S41>/Memory2' */
  t15_2_B.Memory2_ao = t15_2_DWork.Memory2_PreviousInput_a;

  /* Switch: '<S41>/c_eob  1' */
  if (t15_2_B.u_c >= t15_2_P.c_eob1_Threshold_n) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S41>/Selector' */
      t15_2_B.Selector_k[i] = t15_2_B.SFunction1_h[(i << 1) + 1];
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g3ref), &t15_2_B.Selector_k[0],
                         t15_2_B.Times, &t15_2_B.Selector1_c[0], 49U);
    t15_2_B.c_eob1_jl = t15_2_B.g3ref;
  } else {
    t15_2_B.c_eob1_jl = t15_2_B.Memory2_ao;
  }

  /* End of Switch: '<S41>/c_eob  1' */

  /* Memory: '<S41>/Memory1' */
  t15_2_B.Memory1_f = t15_2_DWork.Memory1_PreviousInput_l;

  /* Switch: '<S41>/c_eob  ' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_l0) {
    t15_2_B.c_eob_p = t15_2_B.Times;
  } else {
    t15_2_B.c_eob_p = t15_2_B.Memory1_f;
  }
  ...
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_m) {
    t15_2_B.c_eob_nz = t15_2_B.c_eob1_jl;
  } else {
    /* SignalConversion: '<S47>/TmpSignal ConversionAtg3_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg3_termref[0] = t15_2_B.c_eob1_jl;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S47>/Selector' */
      t15_2_B.Selector_n4[i] = t15_2_B.SFunction1_o[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg3_termref[i + 1] = t15_2_B.Selector_n4[i];
    }

    /* End of SignalConversion: '<S47>/TmpSignal ConversionAtg3_term,refInport3' */

    /* DataStoreRead: '<S47>/Data Store Read1' */
    t15_2_B.DataStoreRead1_pw = t15_2_DWork.trd_ref;

    /* DataStoreRead: '<S47>/Data Store Read' */
    t15_2_B.DataStoreRead_d = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S47>/Selector1' */
      t15_2_B.Selector1_n[i] = t15_2_B.SFunction1_o[i << 1];

      /* Product: '<S47>/Divide6' */
      t15_2_B.Divide6_nx[i] = t15_2_B.Selector1_n[i] * t15_2_B.DataStoreRead_d /
        t15_2_B.DataStoreRead1_pw;

      /* Sum: '<S47>/Add2' */
      t15_2_B.Add2_iy[i] = t15_2_B.c_eob_p + t15_2_B.Divide6_nx[i];
    }
    ...
    LookUp_real_T_real_T( &(t15_2_B.g3_termref),
                         ...
                         t15_2_B.Times, &t15_2_B.Add2_iy[0], 49U);
    t15_2_B.c_eob_nz = t15_2_B.g3_termref;
  }

  /* End of Switch: '<S41>/c_eob' */

  /* Sum: '<S23>/Add3' */
  t15_2_B.Add3 = t15_2_B.e2[2] - t15_2_B.c_eob_nz;
  ...
  /* Switch: '<S42>/c_eob  1' */
  if (t15_2_B.u_c >= t15_2_P.c_eob1_Threshold_c) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S42>/Selector' */
      t15_2_B.Selector_n[i] = t15_2_B.SFunction1_ol[(i << 1) + 1];

      /* Selector: '<S42>/Selector1' */
      t15_2_B.Selector1_pp[i] = t15_2_B.SFunction1_ol[i << 1];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g4ref), &t15_2_B.Selector_n[0],
                         t15_2_B.Times, &t15_2_B.Selector1_pp[0], 49U);
    t15_2_B.c_eob1_g = t15_2_B.g4ref;
  } else {
  ...
  /* Memory: '<S42>/Memory1' */
  t15_2_B.Memory1_m = t15_2_DWork.Memory1_PreviousInput_h;

  /* Switch: '<S42>/c_eob  ' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_b) {
    t15_2_B.c_eob_jm = t15_2_B.Times;
  } else {
    t15_2_B.c_eob_jm = t15_2_B.Memory1_m;
  }
  ...
  /* Switch: '<S42>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_ll) {
    t15_2_B.c_eob_k = t15_2_B.c_eob1_g;
  } else {
    /* SignalConversion: '<S48>/TmpSignal ConversionAtg4_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg4_termref[0] = t15_2_B.c_eob1_g;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S48>/Selector' */
      t15_2_B.Selector_cp[i] = t15_2_B.SFunction1_mh[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg4_termref[i + 1] = t15_2_B.Selector_cp[i];
    }

    /* End of SignalConversion: '<S48>/TmpSignal ConversionAtg4_term,refInport3' */

    /* DataStoreRead: '<S48>/Data Store Read1' */
    t15_2_B.DataStoreRead1_cb = t15_2_DWork.trd_ref;

    /* DataStoreRead: '<S48>/Data Store Read' */
    t15_2_B.DataStoreRead_lw = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S48>/Selector1' */
      t15_2_B.Selector1_p[i] = t15_2_B.SFunction1_mh[i << 1];

      /* Product: '<S48>/Divide6' */
      t15_2_B.Divide6_n[i] = t15_2_B.Selector1_p[i] * t15_2_B.DataStoreRead_lw /
        t15_2_B.DataStoreRead1_cb;

      /* Sum: '<S48>/Add2' */
      t15_2_B.Add2_i[i] = t15_2_B.c_eob_jm + t15_2_B.Divide6_n[i];
    }
    ...
    t15_2_B.c_eob_k = t15_2_B.g4_termref;
  }

  /* End of Switch: '<S42>/c_eob' */

  /* Sum: '<S23>/Add4' */
  t15_2_B.Add4 = t15_2_B.e2[3] - t15_2_B.c_eob_k;

  /* DataStoreRead: '<S23>/Data Store Read' */
  t15_2_B.DataStoreRead_o = t15_2_DWork.t_tran2D;

  /* DataStoreRead: '<S23>/Data Store Read2' */
  t15_2_B.DataStoreRead2_l = t15_2_DWork.tcont2;

  /* MinMax: '<S23>/MinMax' */
  u = t15_2_B.DataStoreRead_o;
  ...
  /* Memory: '<S45>/Memory2' */
  t15_2_B.Memory2_jv = t15_2_DWork.Memory2_PreviousInput_f;

  /* Switch: '<S45>/c_eob  1' */
  if (t15_2_B.u_c >= t15_2_P.c_eob1_Threshold_i) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S45>/Selector' */
      t15_2_B.Selector_c[i] = t15_2_B.SFunction1_g[(i << 1) + 1];

      /* Selector: '<S45>/Selector1' */
      t15_2_B.Selector1_m[i] = t15_2_B.SFunction1_g[i << 1];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g5ref), &t15_2_B.Selector_c[0],
                         t15_2_B.Times, &t15_2_B.Selector1_m[0], 49U);
    t15_2_B.c_eob1_i = t15_2_B.g5ref;
  } else {
    t15_2_B.c_eob1_i = t15_2_B.Memory2_jv;
  }

  /* End of Switch: '<S45>/c_eob  1' */

  /* Memory: '<S45>/Memory1' */
  t15_2_B.Memory1_fu = t15_2_DWork.Memory1_PreviousInput_f;

  /* Switch: '<S45>/c_eob  ' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_n) {
    t15_2_B.c_eob_h = t15_2_B.Times;
  } else {
    t15_2_B.c_eob_h = t15_2_B.Memory1_fu;
  }
  ...
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_e) {
    t15_2_B.c_eob_i = t15_2_B.c_eob1_i;
  } else {
    /* SignalConversion: '<S51>/TmpSignal ConversionAtg5_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg5_termref[0] = t15_2_B.c_eob1_i;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S51>/Selector' */
      t15_2_B.Selector[i] = t15_2_B.SFunction1_ev[((1 + i) << 1) + 1];
    ...
    t15_2_B.DataStoreRead1_b = t15_2_DWork.trd_ref;

    /* DataStoreRead: '<S51>/Data Store Read' */
    t15_2_B.DataStoreRead_pjy = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S51>/Selector1' */
      t15_2_B.Selector1[i] = t15_2_B.SFunction1_ev[i << 1];

      /* Product: '<S51>/Divide6' */
      t15_2_B.Divide6_f[i] = t15_2_B.Selector1[i] * t15_2_B.DataStoreRead_pjy /
        t15_2_B.DataStoreRead1_b;

      /* Sum: '<S51>/Add2' */
      t15_2_B.Add2_h[i] = t15_2_B.c_eob_h + t15_2_B.Divide6_f[i];
    }
    ...
    t15_2_B.c_eob_i = t15_2_B.g5_termref;
  }

  /* End of Switch: '<S45>/c_eob' */

  /* Sum: '<S23>/Add5' */
  t15_2_B.Add5 = t15_2_B.c_eob_i - t15_2_B.e2[4];
  ...
  /* Memory: '<S43>/Memory2' */
  t15_2_B.Memory2_b = t15_2_DWork.Memory2_PreviousInput_j;

  /* Switch: '<S43>/c_eob  1' */
  if (t15_2_B.u_c >= t15_2_P.c_eob1_Threshold_p) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S43>/Selector' */
      t15_2_B.Selector_om[i] = t15_2_B.SFunction1_dk[(i << 1) + 1];

      /* Selector: '<S43>/Selector1' */
      t15_2_B.Selector1_d[i] = t15_2_B.SFunction1_dk[i << 1];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g6ref), &t15_2_B.Selector_om[0],
                         t15_2_B.Times, &t15_2_B.Selector1_d[0], 49U);
    t15_2_B.c_eob1_a = t15_2_B.g6ref;
  } else {
    t15_2_B.c_eob1_a = t15_2_B.Memory2_b;
  }

  /* End of Switch: '<S43>/c_eob  1' */

  /* Memory: '<S43>/Memory1' */
  t15_2_B.Memory1_n = t15_2_DWork.Memory1_PreviousInput_k;

  /* Switch: '<S43>/c_eob  ' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_l3) {
    t15_2_B.c_eob_ck = t15_2_B.Times;
  } else {
    t15_2_B.c_eob_ck = t15_2_B.Memory1_n;
  }
  ...
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_o) {
    t15_2_B.c_eob_h4 = t15_2_B.c_eob1_a;
  } else {
    /* SignalConversion: '<S49>/TmpSignal ConversionAtg6_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg6_termref[0] = t15_2_B.c_eob1_a;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S49>/Selector' */
      t15_2_B.Selector_j[i] = t15_2_B.SFunction1_l0[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg6_termref[i + 1] = t15_2_B.Selector_j[i];
    }

    /* End of SignalConversion: '<S49>/TmpSignal ConversionAtg6_term,refInport3' */

    /* DataStoreRead: '<S49>/Data Store Read1' */
    t15_2_B.DataStoreRead1_iu = t15_2_DWork.trd_ref;

    /* DataStoreRead: '<S49>/Data Store Read' */
    t15_2_B.DataStoreRead_fs = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S49>/Selector1' */
      t15_2_B.Selector1_j[i] = t15_2_B.SFunction1_l0[i << 1];

      /* Product: '<S49>/Divide6' */
      t15_2_B.Divide6_p[i] = t15_2_B.Selector1_j[i] * t15_2_B.DataStoreRead_fs /
        t15_2_B.DataStoreRead1_iu;

      /* Sum: '<S49>/Add2' */
      t15_2_B.Add2_f5[i] = t15_2_B.c_eob_ck + t15_2_B.Divide6_p[i];
    }
    ...
    LookUp_real_T_real_T( &(t15_2_B.g6_termref),
                         ...
                         t15_2_B.Times, &t15_2_B.Add2_f5[0], 49U);
    t15_2_B.c_eob_h4 = t15_2_B.g6_termref;
  }

  /* End of Switch: '<S43>/c_eob' */

  /* Sum: '<S23>/Add6' */
  t15_2_B.Add6 = t15_2_B.e2[5] - t15_2_B.c_eob_h4;

  /* Product: '<S23>/Divide1' */
  t15_2_B.Divide1 = t15_2_B.Add6 * t15_2_B.RelationalOperator1;

  /* Gain: '<S23>/1e-2' */
  t15_2_B.e2_b[0] = t15_2_P.e2_Gain_m * t15_2_B.Add2_p;
  t15_2_B.e2_b[1] = t15_2_P.e2_Gain_m * t15_2_B.Add1_g;
  t15_2_B.e2_b[2] = t15_2_P.e2_Gain_m * t15_2_B.Divide2;
  t15_2_B.e2_b[3] = t15_2_P.e2_Gain_m * t15_2_B.Divide12;
  t15_2_B.e2_b[4] = t15_2_P.e2_Gain_m * t15_2_B.Add5;
  t15_2_B.e2_b[5] = t15_2_P.e2_Gain_m * t15_2_B.Divide1;

  /* Memory: '<S29>/Memory2' */
  t15_2_B.Memory2_o = t15_2_DWork.Memory2_PreviousInput_e;

  /* Switch: '<S29>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_do) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S29>/Data Store Read1' */
      t15_2_B.DataStoreRead1_gn[i] = t15_2_DWork.scr_data[13 * i + 2];

      /* DataStoreRead: '<S29>/Data Store Read' */
      t15_2_B.DataStoreRead_f3[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_g), &t15_2_B.DataStoreRead1_gn[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_f3[0], 499U);
    t15_2_B.c_eob_na = t15_2_B.I1_g;
  } else {
    t15_2_B.c_eob_na = t15_2_B.Memory2_o;
  }

  /* End of Switch: '<S29>/c_eob' */

  /* Product: '<S29>/Divide1' */
  t15_2_B.Divide1_f = t15_2_B.c_eob_na * t15_2_B.u_c;

  /* Sum: '<S22>/Add3' */
  t15_2_B.Add3_c = t15_2_B.e6_h[0] - t15_2_B.Divide1_f;

  /* Memory: '<S32>/Memory2' */
  t15_2_B.Memory2_k = t15_2_DWork.Memory2_PreviousInput_ad;

  /* Switch: '<S32>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_mt) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S32>/Data Store Read1' */
      t15_2_B.DataStoreRead1_g5[i] = t15_2_DWork.scr_data[13 * i + 3];

      /* DataStoreRead: '<S32>/Data Store Read' */
      t15_2_B.DataStoreRead_dn[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_f), &t15_2_B.DataStoreRead1_g5[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_dn[0], 499U);
    t15_2_B.c_eob_b = t15_2_B.I1_f;
  } else {
    t15_2_B.c_eob_b = t15_2_B.Memory2_k;
  }

  /* End of Switch: '<S32>/c_eob' */

  /* Product: '<S32>/Divide1' */
  t15_2_B.Divide1_n = t15_2_B.c_eob_b * t15_2_B.u_c;

  /* Sum: '<S22>/Add1' */
  t15_2_B.Add1_b = t15_2_B.e6_h[1] - t15_2_B.Divide1_n;

  /* Memory: '<S33>/Memory2' */
  t15_2_B.Memory2_e = t15_2_DWork.Memory2_PreviousInput_mc4;

  /* Switch: '<S33>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_m4) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S33>/Data Store Read1' */
      t15_2_B.DataStoreRead1_di[i] = t15_2_DWork.scr_data[13 * i + 4];

      /* DataStoreRead: '<S33>/Data Store Read' */
      t15_2_B.DataStoreRead_fy[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_mn), &t15_2_B.DataStoreRead1_di[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_fy[0], 499U);
    t15_2_B.c_eob_e = t15_2_B.I1_mn;
  } else {
  ...
  /* Product: '<S33>/Divide1' */
  t15_2_B.Divide1_d = t15_2_B.c_eob_e * t15_2_B.u_c;

  /* Sum: '<S22>/Add2' */
  t15_2_B.Add2_f = t15_2_B.e6_h[2] - t15_2_B.Divide1_d;

  /* Memory: '<S34>/Memory2' */
  t15_2_B.Memory2_d = t15_2_DWork.Memory2_PreviousInput_d;

  /* Switch: '<S34>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_k) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S34>/Data Store Read1' */
      t15_2_B.DataStoreRead1_g[i] = t15_2_DWork.scr_data[13 * i + 5];

      /* DataStoreRead: '<S34>/Data Store Read' */
      t15_2_B.DataStoreRead_n2[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_k), &t15_2_B.DataStoreRead1_g[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_n2[0], 499U);
    t15_2_B.c_eob_m = t15_2_B.I1_k;
  } else {
    t15_2_B.c_eob_m = t15_2_B.Memory2_d;
  }

  /* End of Switch: '<S34>/c_eob' */

  /* Product: '<S34>/Divide1' */
  t15_2_B.Divide1_a = t15_2_B.c_eob_m * t15_2_B.u_c;

  /* Sum: '<S22>/Add4' */
  t15_2_B.Add4_b = t15_2_B.e6_h[3] - t15_2_B.Divide1_a;

  /* Memory: '<S35>/Memory2' */
  t15_2_B.Memory2_g = t15_2_DWork.Memory2_PreviousInput_i;

  /* Switch: '<S35>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_d1) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S35>/Data Store Read1' */
      t15_2_B.DataStoreRead1_f4[i] = t15_2_DWork.scr_data[13 * i + 6];

      /* DataStoreRead: '<S35>/Data Store Read' */
      t15_2_B.DataStoreRead_oi[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_nt), &t15_2_B.DataStoreRead1_f4[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_oi[0], 499U);
    t15_2_B.c_eob_ay = t15_2_B.I1_nt;
  } else {
    t15_2_B.c_eob_ay = t15_2_B.Memory2_g;
  }

  /* End of Switch: '<S35>/c_eob' */

  /* Product: '<S35>/Divide1' */
  t15_2_B.Divide1_d1 = t15_2_B.c_eob_ay * t15_2_B.u_c;

  /* Sum: '<S22>/Add5' */
  t15_2_B.Add5_b = t15_2_B.e6_h[4] - t15_2_B.Divide1_d1;

  /* Memory: '<S36>/Memory2' */
  t15_2_B.Memory2_or = t15_2_DWork.Memory2_PreviousInput_eq;

  /* Switch: '<S36>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_nq) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S36>/Data Store Read1' */
      t15_2_B.DataStoreRead1_n1[i] = t15_2_DWork.scr_data[13 * i + 7];

      /* DataStoreRead: '<S36>/Data Store Read' */
      t15_2_B.DataStoreRead_fe[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_n), &t15_2_B.DataStoreRead1_n1[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_fe[0], 499U);
    t15_2_B.c_eob_b4 = t15_2_B.I1_n;
  } else {
    t15_2_B.c_eob_b4 = t15_2_B.Memory2_or;
  }

  /* End of Switch: '<S36>/c_eob' */

  /* Product: '<S36>/Divide1' */
  t15_2_B.Divide1_fe = t15_2_B.c_eob_b4 * t15_2_B.u_c;

  /* Sum: '<S22>/Add6' */
  t15_2_B.Add6_k = t15_2_B.e6_h[5] - t15_2_B.Divide1_fe;

  /* Memory: '<S37>/Memory2' */
  t15_2_B.Memory2_mv = t15_2_DWork.Memory2_PreviousInput_br;

  /* Switch: '<S37>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_f) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S37>/Data Store Read1' */
      t15_2_B.DataStoreRead1_c3[i] = t15_2_DWork.scr_data[13 * i + 8];

      /* DataStoreRead: '<S37>/Data Store Read' */
      t15_2_B.DataStoreRead_bp[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_a), &t15_2_B.DataStoreRead1_c3[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_bp[0], 499U);
    t15_2_B.c_eob_g = t15_2_B.I1_a;
  } else {
    t15_2_B.c_eob_g = t15_2_B.Memory2_mv;
  }

  /* End of Switch: '<S37>/c_eob' */

  /* Product: '<S37>/Divide1' */
  t15_2_B.Divide1_l = t15_2_B.c_eob_g * t15_2_B.u_c;

  /* Sum: '<S22>/Add7' */
  t15_2_B.Add7 = t15_2_B.e6_h[6] - t15_2_B.Divide1_l;

  /* Memory: '<S38>/Memory2' */
  t15_2_B.Memory2_j0 = t15_2_DWork.Memory2_PreviousInput_n;

  /* Switch: '<S38>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_dn) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S38>/Data Store Read1' */
      t15_2_B.DataStoreRead1_ds[i] = t15_2_DWork.scr_data[13 * i + 9];

      /* DataStoreRead: '<S38>/Data Store Read' */
      t15_2_B.DataStoreRead_bv[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_m), &t15_2_B.DataStoreRead1_ds[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_bv[0], 499U);
    t15_2_B.c_eob_b2 = t15_2_B.I1_m;
  } else {
    t15_2_B.c_eob_b2 = t15_2_B.Memory2_j0;
  }

  /* End of Switch: '<S38>/c_eob' */

  /* Product: '<S38>/Divide1' */
  t15_2_B.Divide1_lo = t15_2_B.c_eob_b2 * t15_2_B.u_c;

  /* Sum: '<S22>/Add8' */
  t15_2_B.Add8 = t15_2_B.e6_h[7] - t15_2_B.Divide1_lo;

  /* Memory: '<S39>/Memory2' */
  t15_2_B.Memory2_ke = t15_2_DWork.Memory2_PreviousInput_c;

  /* Switch: '<S39>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_hv) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S39>/Data Store Read1' */
      t15_2_B.DataStoreRead1_eh[i] = t15_2_DWork.scr_data[13 * i + 10];

      /* DataStoreRead: '<S39>/Data Store Read' */
      t15_2_B.DataStoreRead_o2[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1), &t15_2_B.DataStoreRead1_eh[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_o2[0], 499U);
    t15_2_B.c_eob_gg = t15_2_B.I1;
  } else {
    t15_2_B.c_eob_gg = t15_2_B.Memory2_ke;
  }

  /* End of Switch: '<S39>/c_eob' */

  /* Product: '<S39>/Divide1' */
  t15_2_B.Divide1_h = t15_2_B.c_eob_gg * t15_2_B.u_c;

  /* Sum: '<S22>/Add9' */
  t15_2_B.Add9 = t15_2_B.e6_h[8] - t15_2_B.Divide1_h;

  /* Memory: '<S30>/Memory2' */
  t15_2_B.Memory2_c = t15_2_DWork.Memory2_PreviousInput_jn;

  /* Switch: '<S30>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_nd) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S30>/Data Store Read1' */
      t15_2_B.DataStoreRead1_ez[i] = t15_2_DWork.scr_data[13 * i + 11];

      /* DataStoreRead: '<S30>/Data Store Read' */
      t15_2_B.DataStoreRead_dn5[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_p), &t15_2_B.DataStoreRead1_ez[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_dn5[0], 499U);
    t15_2_B.c_eob_en = t15_2_B.I1_p;
  } else {
    t15_2_B.c_eob_en = t15_2_B.Memory2_c;
  }

  /* End of Switch: '<S30>/c_eob' */

  /* Product: '<S30>/Divide1' */
  t15_2_B.Divide1_k = t15_2_B.c_eob_en * t15_2_B.u_c;

  /* Sum: '<S22>/Add10' */
  t15_2_B.Add10 = t15_2_B.e6_h[9] - t15_2_B.Divide1_k;

  /* Memory: '<S31>/Memory2' */
  t15_2_B.Memory2_p = t15_2_DWork.Memory2_PreviousInput_nq;

  /* Switch: '<S31>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_nk) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S31>/Data Store Read1' */
      t15_2_B.DataStoreRead1_gs[i] = t15_2_DWork.scr_data[13 * i + 12];

      /* DataStoreRead: '<S31>/Data Store Read' */
      t15_2_B.DataStoreRead_hb[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_h), &t15_2_B.DataStoreRead1_gs[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_hb[0], 499U);
    t15_2_B.c_eob_ev = t15_2_B.I1_h;
  } else {
    t15_2_B.c_eob_ev = t15_2_B.Memory2_p;
  }

  /* End of Switch: '<S31>/c_eob' */

  /* Product: '<S31>/Divide1' */
  t15_2_B.Divide1_lf = t15_2_B.c_eob_ev * t15_2_B.u_c;

  /* Sum: '<S22>/Add11' */
  t15_2_B.Add11 = t15_2_B.e6_h[10] - t15_2_B.Divide1_lf;

  /* DataStoreRead: '<S17>/Data Store Read1' */
  t15_2_B.DataStoreRead1_nr = t15_2_DWork.Ip_div;

  /* RelationalOperator: '<S17>/Relational Operator' */
  t15_2_B.RelationalOperator_c = (t15_2_B.e6 > t15_2_B.DataStoreRead1_nr);

  /* Memory: '<S25>/Memory' */
  t15_2_B.Memory_c = t15_2_DWork.Memory_PreviousInput_i;

  /* Logic: '<S25>/Logical Operator' */
  t15_2_B.LogicalOperator_h = ((t15_2_B.RelationalOperator_c != 0.0) ||
    (t15_2_B.Memory_c != 0.0));

  /* Switch: '<S17>/1' incorporates:
   *  Constant: '<S14>/Constant4'
   */
  if (t15_2_B.LogicalOperator_h >= t15_2_P._Threshold) {
    for (i = 0; i < 6; i++) {
      t15_2_B.u_g[i] = t15_2_B.e2_b[i];
    }

    t15_2_B.u_g[6] = t15_2_P.Constant4_Value_g;
    t15_2_B.u_g[7] = t15_2_B.Add1_f;
    t15_2_B.u_g[8] = t15_2_B.Add3_c;
    t15_2_B.u_g[9] = t15_2_B.Add1_b;
    t15_2_B.u_g[10] = t15_2_B.Add2_f;
    t15_2_B.u_g[11] = t15_2_B.Add4_b;
    t15_2_B.u_g[12] = t15_2_B.Add5_b;
    t15_2_B.u_g[13] = t15_2_B.Add6_k;
    ...
    t15_2_B.u_g[19] = t15_2_P.Constant4_Value_g;
  } else {
    for (i = 0; i < 50; i++) {
      ...
      t15_2_B.Selector1_k4[i] = t15_2_B.SFunction1_d[i << 1];
    }
    ...
    LookUp_real_T_real_T( &(t15_2_B.elong), &t15_2_B.Selector_h[0],
                         t15_2_B.Times, &t15_2_B.Selector1_k4[0], 49U);

    /* Sum: '<S14>/Add2' incorporates:
     *  Inport: '<Root>/In1'
     */
    t15_2_B.Add2_ho = t15_2_U.In1[2] - t15_2_B.elong;

    /* DataStoreRead: '<S24>/Data Store Read1' */
    t15_2_B.DataStoreRead1_o = t15_2_DWork.k_g4;
     ...
     */
    t15_2_B.Divide_c[0] = t15_2_B.e2_b[2] * t15_2_P.Constant4_Value;
    t15_2_B.Divide_c[1] = t15_2_B.e2_b[3] * t15_2_B.DataStoreRead1_o;
    t15_2_B.Divide_c[2] = t15_2_B.e2_b[4] * t15_2_P.Constant1_Value;
    t15_2_B.Divide_c[3] = t15_2_B.e2_b[5] * t15_2_P.Constant2_Value;
    t15_2_B.u_g[0] = t15_2_B.Add2_ho;
    t15_2_B.u_g[1] = t15_2_P.Constant4_Value_g;
    t15_2_B.u_g[2] = t15_2_B.Divide_c[0];
    t15_2_B.u_g[3] = t15_2_B.Divide_c[1];
    t15_2_B.u_g[4] = t15_2_B.Divide_c[2];
    t15_2_B.u_g[5] = t15_2_B.Divide_c[3];
    t15_2_B.u_g[6] = t15_2_P.Constant4_Value_g;
    t15_2_B.u_g[7] = t15_2_B.Add1_f;
    t15_2_B.u_g[8] = t15_2_B.Add3_c;
    t15_2_B.u_g[9] = t15_2_B.Add1_b;
  ...
  /* UnitDelay: '<S28>/UD' */
  t15_2_B.Uk1_k = t15_2_DWork.UD_DSTATE_b;

  /* Sum: '<S28>/Diff' */
  t15_2_B.Diff_h = t15_2_B.Times - t15_2_B.Uk1_k;

  /* Product: '<S20>/Divide' */
  t15_2_B.Divide = t15_2_B.Diff / t15_2_B.Diff_h;

  /* DataStoreRead: '<S15>/Data Store Read' */
  t15_2_B.DataStoreRead_k = t15_2_DWork.c_a_tpl1_eob;

  /* Gain: '<S15>/ 1//15' */
  t15_2_B.u15 = t15_2_P.u15_Gain_m * t15_2_B.DataStoreRead_k;

  /* RelationalOperator: '<S68>/Compare' incorporates:
   *  Constant: '<S68>/Constant'
   */
  t15_2_B.Compare_b = (t15_2_B.u_c < t15_2_P.Constant_Value);
  ...
  /* Abs: '<S69>/Abs' */
  t15_2_B.Abs = fabs(t15_2_B.DataStoreRead_k2);

  /* RelationalOperator: '<S69>/Relational Operator' */
  t15_2_B.RelationalOperator_k = (t15_2_B.e6 < t15_2_B.Abs);

  /* Logic: '<S52>/Logical Operator1' */
  t15_2_B.LogicalOperator1 = (t15_2_B.RelationalOperator_k && t15_2_B.Compare_b);

  /* Switch: '<S52>/switch1 ' */
  if (t15_2_B.LogicalOperator1 >= t15_2_P.switch1_Threshold_p) {
  ...
  /* Product: '<S52>/Divide1' */
  t15_2_B.Divide1_j = 1.0 / t15_2_B.DataStoreRead_p * t15_2_B.Subtract2;

  /* Sum: '<S52>/Subtract1' incorporates:
   *  Constant: '<S52>/1'
   */
  t15_2_B.Subtract1 = t15_2_B.Divide1_j + t15_2_P._Value_mx;

  /* Saturate: '<S52>/Saturation1' */
  u = t15_2_B.Subtract1;
  tmin = t15_2_P.Saturation1_LowerSat_j;
  u_0 = t15_2_P.Saturation1_UpperSat_c;
  if (u >= u_0) {
  ...
  /* Memory: '<S52>/Memory1' */
  memcpy(&t15_2_B.Memory1_e[0], &t15_2_DWork.Memory1_PreviousInput_i3[0], 11U *
         sizeof(real_T));

  /* Memory: '<S64>/Memory1' */
  t15_2_B.Memory1_kk = t15_2_DWork.Memory1_PreviousInput_iu;

  /* Switch: '<S64>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_p) {
    t15_2_B.c_eob_jma = t15_2_B.e6;
  } else {
    t15_2_B.c_eob_jma = t15_2_B.Memory1_kk;
  }
  ...
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_a) {
    ...
    t15_2_B.DataStoreRead2_pa = t15_2_DWork.c_a_tpl2;

    /* Gain: '<S15>/ 1//15 ' */
    t15_2_B.u15_j = t15_2_P.u15_Gain * t15_2_B.DataStoreRead2_pa;
    ...
    if (u >= u_0) {
      t15_2_B.Saturation_j = u_0;
    } else if (u <= tmin) {
      t15_2_B.Saturation_j = tmin;
    } else {
      t15_2_B.Saturation_j = u;
    }

    /* End of Saturate: '<S15>/Saturation' */
    t15_2_B.c_eob_o = t15_2_B.Saturation_j;
  } else {
    /* DataStoreRead: '<S64>/Data Store Read2' */
    t15_2_B.DataStoreRead2_lw = t15_2_DWork.y0;

    /* Sum: '<S64>/Sum3' incorporates:
     *  Constant: '<S64>/2'
     */
    t15_2_B.Sum3_d = t15_2_P._Value - t15_2_B.DataStoreRead2_lw;

    /* DataStoreRead: '<S64>/Data Store Read4' */
    t15_2_B.DataStoreRead4_o = t15_2_DWork.c2_y0;

    /* DataStoreRead: '<S64>/Data Store Read3' */
    t15_2_B.DataStoreRead3_m = t15_2_DWork.c1_y0;

    /* Sum: '<S64>/Sum2' */
    t15_2_B.Sum2_hd = t15_2_B.DataStoreRead4_o - t15_2_B.DataStoreRead3_m;

    /* Product: '<S64>/Divide1' */
    t15_2_B.Divide1_m = 1.0 / t15_2_B.Sum2_hd * t15_2_B.Sum3_d;

    /* Product: '<S64>/Divide6' */
    t15_2_B.Divide6_k1 = t15_2_B.c_eob_jma * t15_2_B.u_c;

    /* Sum: '<S64>/Sum' */
    t15_2_B.Sum = t15_2_B.Divide6_k1 - t15_2_B.DataStoreRead3_m;

    /* Product: '<S64>/Divide2' */
    t15_2_B.Divide2_p = t15_2_B.Sum * t15_2_B.Divide1_m;

    /* Sum: '<S64>/Sum1' */
    t15_2_B.Sum1_n = t15_2_B.Divide2_p + t15_2_B.DataStoreRead2_lw;

    /* RelationalOperator: '<S84>/LowerRelop1' incorporates:
     *  Constant: '<S64>/1'
     */
    t15_2_B.LowerRelop1_o = (t15_2_B.Sum1_n > t15_2_P._Value_e);

    /* Switch: '<S84>/Switch2' incorporates:
     *  Constant: '<S64>/1'
     */
    if (t15_2_B.LowerRelop1_o) {
      t15_2_B.Switch2_g = t15_2_P._Value_e;
    } else {
      /* RelationalOperator: '<S84>/UpperRelop' */
      t15_2_B.UpperRelop_f = (t15_2_B.Sum1_n < t15_2_B.DataStoreRead2_lw);

      /* Switch: '<S84>/Switch' */
      if (t15_2_B.UpperRelop_f) {
        t15_2_B.Switch_m = t15_2_B.DataStoreRead2_lw;
      } else {
        t15_2_B.Switch_m = t15_2_B.Sum1_n;
      }

      /* End of Switch: '<S84>/Switch' */
      t15_2_B.Switch2_g = t15_2_B.Switch_m;
    }

    /* End of Switch: '<S84>/Switch2' */
    t15_2_B.c_eob_o = t15_2_B.Switch2_g;
  }

  /* End of Switch: '<S15>/c_eob' */

  /* DataStoreRead: '<S75>/Data Store Read' */
  t15_2_B.DataStoreRead_n = t15_2_DWork.tcont2;

  /* RelationalOperator: '<S75>/Relational Operator' */
  t15_2_B.RelationalOperator_n = (t15_2_B.Times > t15_2_B.DataStoreRead_n);

  /* Product: '<S75>/Divide12' */
  for (i = 0; i < 20; i++) {
    t15_2_B.Divide12_f[i] = t15_2_B.u_g[i] * (real_T)
  ...
  /* DiscreteStateSpace: '<S55>/Lim. contr.' */
  {
...

    {
      ...
      const real_T *u = &t15_2_B.Divide12_f[0];
      real_T *y0 = &t15_2_B.Limcontr[0];
      int_T numNonZero = 17;
      while (numNonZero--) {
        *y0 += (*pD0++) * u[*pDidx++];
  ...
  if (t15_2_B.LogicalOperator1 >= t15_2_P.switch1_Threshold_i) {
    memcpy(&t15_2_B.switch1_h[0], &t15_2_B.Memory1_e[0], 11U * sizeof(real_T));
  } else {
    /* DataStoreRead: '<S76>/Data Store Read' */
    t15_2_B.DataStoreRead_l5 = t15_2_DWork.tcont2;

    /* RelationalOperator: '<S76>/Relational Operator' */
    t15_2_B.RelationalOperator_e = (t15_2_B.Times > t15_2_B.DataStoreRead_l5);

    /* Switch: '<S76>/1' */
    if (t15_2_B.RelationalOperator_e) {
      /* DataStoreRead: '<S74>/Data Store Read1' */
      t15_2_B.DataStoreRead1_i = t15_2_DWork.dtcont2;

      /* DataStoreRead: '<S74>/Data Store Read' */
      t15_2_B.DataStoreRead_ak = t15_2_DWork.tcont2;

      /* Sum: '<S74>/Subtract3' */
      t15_2_B.Subtract3_i = t15_2_B.Times - t15_2_B.DataStoreRead_ak;

      /* Product: '<S74>/Divide2' */
      t15_2_B.Divide2_c = t15_2_B.Subtract3_i / t15_2_B.DataStoreRead1_i;
      ...
      if (u >= u_0) {
        t15_2_B.Saturation1_a = u_0;
      } else if (u <= tmin) {
        t15_2_B.Saturation1_a = tmin;
      } else {
        t15_2_B.Saturation1_a = u;
      }
      ...
      /* Product: '<S55>/Divide ' */
      for (i = 0; i < 11; i++) {
        t15_2_B.Divide_mg[i] = t15_2_B.c_eob_o * t15_2_B.Limcontr[i] *
          t15_2_B.Saturation1_a;
        t15_2_B.u_p[i] = t15_2_B.Divide_mg[i];
      }
      ...
      /* Product: '<S55>/Divide2' */
      for (i = 0; i < 11; i++) {
        t15_2_B.Divide2_k[i] = t15_2_B.Currcontr[i] / t15_2_B.DataStoreRead2_p[i];
        t15_2_B.u_p[i] = t15_2_B.Divide2_k[i];
      }
    ...
    /* End of Switch: '<S76>/1' */
    memcpy(&t15_2_B.switch1_h[0], &t15_2_B.u_p[0], 11U * sizeof(real_T));
  }
   ...
   *  Constant: '<S52>/1'
   */
  t15_2_B.Subtract3 = t15_2_P._Value_mx - t15_2_B.Saturation1;

  /* DataStoreRead: '<S53>/Data Store Read1' */
  t15_2_B.DataStoreRead1_e5 = t15_2_DWork.c_cur_max;
  ...
  t15_2_B.RelationalOperator_o = (t15_2_B.e6 < t15_2_B.Abs_j);

  /* RelationalOperator: '<S85>/Compare' incorporates:
   *  Constant: '<S85>/Constant'
   */
  t15_2_B.Compare_m = (t15_2_B.u_c < t15_2_P.Constant_Value_i);

  /* Logic: '<S66>/Logical Operator2' */
  t15_2_B.LogicalOperator2 = (t15_2_B.RelationalOperator_o && t15_2_B.Compare_m);

  /* DataStoreRead: '<S58>/Data Store Read' */
  t15_2_B.DataStoreRead_p3 = t15_2_DWork.Ip_rd;

  /* RelationalOperator: '<S58>/Relational Operator1' */
  t15_2_B.RelationalOperator1_j = (t15_2_B.e6 < t15_2_B.DataStoreRead_p3);

  /* RelationalOperator: '<S77>/Compare' incorporates:
   *  Constant: '<S77>/Constant'
   */
  t15_2_B.Compare_c = (t15_2_B.u_c < t15_2_P.Constant_Value_f);

  /* DataStoreRead: '<S58>/Data Store Read1' */
  t15_2_B.DataStoreRead1_j = t15_2_DWork.RupRd[2];

  /* Abs: '<S58>/Abs' */
  t15_2_B.Abs_m = fabs(t15_2_B.DataStoreRead1_j);

  /* RelationalOperator: '<S58>/Relational Operator' */
  t15_2_B.RelationalOperator_m = (t15_2_B.e6 > t15_2_B.Abs_m);

  /* Logic: '<S58>/Logical Operator1' */
  t15_2_B.LogicalOperator1_f = (t15_2_B.RelationalOperator1_j &&
    t15_2_B.Compare_c && t15_2_B.RelationalOperator_m);
  ...
  for (i = 0; i < 11; i++) {
    /* Product: '<S52>/Divide5' */
    t15_2_B.Divide5[i] = t15_2_B.Saturation1 * t15_2_B.switch1_h[i];

    /* Gain: '<S53>/1e3' */
    t15_2_B.e3_g[i] = t15_2_P.e3_Gain_i * t15_2_B.e6_h[i];

    /* Abs: '<S53>/Abs' */
    t15_2_B.Abs_f[i] = fabs(t15_2_B.e3_g[i]);
    ...
    /* Product: '<S53>/Divide5' */
    t15_2_B.Divide5_b[i] = t15_2_B.DataStoreRead1_e[i] *
      t15_2_B.DataStoreRead2_f[i];

    /* Sum: '<S53>/Sum2' */
    t15_2_B.Sum2_k[i] = t15_2_B.Divide5_b[i] - t15_2_B.Abs_f[i];

    /* Product: '<S53>/Divide3' */
    t15_2_B.Divide3[i] = t15_2_B.Divide5_b[i] * t15_2_B.DataStoreRead1_e5;

    /* Sum: '<S53>/Sum1' */
    t15_2_B.Sum1[i] = t15_2_B.Divide5_b[i] - t15_2_B.Divide3[i];

    /* Product: '<S53>/Divide4' */
    t15_2_B.Divide4[i] = t15_2_B.Sum2_k[i] / t15_2_B.Sum1[i];

    /* Product: '<S53>/Divide1' */
    t15_2_B.Divide1_aw[i] = t15_2_B.Divide4[i] * t15_2_B.Divide4[i] *
      t15_2_B.Divide4[i];

    /* Saturate: '<S53>/Saturation' */
    u = t15_2_B.Divide1_aw[i];
    tmin = t15_2_P.Saturation_LowerSat_m;
    u_0 = t15_2_P.Saturation_UpperSat_j;
    if (u >= u_0) {
      u = u_0;
    } else {
      if (u <= tmin) {
    ...
    /* Memory: '<S66>/Memory1' */
    t15_2_B.Memory1_ja[i] = t15_2_DWork.Memory1_PreviousInput_c[i];

    /* Memory: '<S58>/Memory' */
    t15_2_B.Memory_i[i] = t15_2_DWork.Memory_PreviousInput_c[i];

    /* Switch: '<S58>/0.1' */
    if (t15_2_B.LogicalOperator1_f >= t15_2_P.u_Threshold) {
      t15_2_B.u_e[i] = t15_2_B.Memory_i[i];
    } else {
      /* Product: '<S15>/Divide' */
      t15_2_B.Divide_j[i] = t15_2_B.c_eob_o * t15_2_B.Divcontr[i] *
        t15_2_B.Subtract3;
      t15_2_B.u_e[i] = t15_2_B.Divide_j[i];
    }
  ...
  /* Memory: '<S62>/Memory1' */
  t15_2_B.Memory1_kr = t15_2_DWork.Memory1_PreviousInput_fx;

  /* DataStoreRead: '<S62>/Data Store Read' */
  t15_2_B.DataStoreRead_hc = t15_2_DWork.Ip_rd;

  /* RelationalOperator: '<S62>/Relational Operator1' */
  t15_2_B.RelationalOperator1_m = (t15_2_B.e6 < t15_2_B.DataStoreRead_hc);

  /* RelationalOperator: '<S81>/Compare' incorporates:
   *  Constant: '<S81>/Constant'
   */
  t15_2_B.Compare_i = (t15_2_B.u_c < t15_2_P.Constant_Value_ir);

  /* Logic: '<S62>/Logical Operator1' */
  t15_2_B.LogicalOperator1_a = (t15_2_B.RelationalOperator1_m &&
    t15_2_B.Compare_i);

  /* Switch: '<S62>/switch1' */
  if (t15_2_B.LogicalOperator1_a >= t15_2_P.switch1_Threshold_d) {
    t15_2_B.switch1_k = t15_2_B.Memory1_kr;
  } else {
    t15_2_B.switch1_k = t15_2_B.Times;
  }
  ...
  /* Switch: '<S66>/1' */
  if (t15_2_B.LogicalOperator2 >= t15_2_P._Threshold_j) {
    memcpy(&t15_2_B.u_o[0], &t15_2_B.Memory1_ja[0], 11U * sizeof(real_T));
  } else {
    /* Sum: '<S62>/Subtract2' */
    t15_2_B.Subtract2_j = t15_2_B.switch1_k - t15_2_B.Times;

    /* DataStoreRead: '<S62>/Data Store Read1' */
    t15_2_B.DataStoreRead1_cr = t15_2_DWork.ref_ramp;

    /* Product: '<S62>/Divide4' */
    t15_2_B.Divide4_nc = 1.0 / t15_2_B.DataStoreRead1_cr * t15_2_B.Subtract2_j;

    /* Sum: '<S62>/Subtract3' incorporates:
     *  Constant: '<S62>/1'
     */
    t15_2_B.Subtract3_j = t15_2_B.Divide4_nc + t15_2_P._Value_a;

    /* Saturate: '<S62>/Saturation' */
    u = t15_2_B.Subtract3_j;
     ...
     *  Constant: '<S62>/1'
     */
    t15_2_B.Subtract1_l = t15_2_P._Value_a - t15_2_B.Saturation_g;
    for (i = 0; i < 11; i++) {
      /* Product: '<S15>/Divide3' */
      t15_2_B.Divide3_a[i] = t15_2_B.Div_rdcontr[i] * t15_2_B.c_eob_o *
        t15_2_B.Subtract1_l;

      /* Product: '<S15>/Divide1' */
      t15_2_B.Divide1_hq[i] = t15_2_B.u_e[i] * t15_2_B.Saturation_g;

      /* Sum: '<S15>/Sum2' */
      t15_2_B.Sum2_j[i] = t15_2_B.Divide1_hq[i] + t15_2_B.Divide3_a[i];
      t15_2_B.u_o[i] = t15_2_B.Sum2_j[i];
    }
  }
  ...
  t15_2_B.DataStoreRead_a = t15_2_DWork.RupRd[2];

  /* Abs: '<S73>/Abs' */
  t15_2_B.Abs_f2 = fabs(t15_2_B.DataStoreRead_a);

  /* RelationalOperator: '<S73>/Relational Operator' */
  t15_2_B.RelationalOperator_f = (t15_2_B.e6 < t15_2_B.Abs_f2);

  /* RelationalOperator: '<S72>/Compare' incorporates:
   *  Constant: '<S72>/Constant'
   */
  t15_2_B.Compare_bp = (t15_2_B.e6 < t15_2_P.Constant_Value_d);

  /* Logic: '<S54>/Logical Operator2' */
  t15_2_B.LogicalOperator2_h = (t15_2_B.RelationalOperator_f &&
    t15_2_B.Compare_bp);

  /* Sum: '<S54>/Subtract4' incorporates:
   *  Constant: '<S54>/1'
   */
  t15_2_B.Subtract4 = t15_2_P._Value_k - t15_2_B.LogicalOperator2_h;
  ...
  for (i = 0; i < 11; i++) {
    /* Product: '<S15>/Divide4' */
    t15_2_B.Divide4_g[i] = t15_2_B.u_o[i] * t15_2_B.Subtract4;
  ...
  for (i = 0; i < 500; i++) {
    ...
    t15_2_B.DataStoreRead_i[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S86>/0.001' */
    t15_2_B.u01[i] = t15_2_P.u01_Gain * t15_2_B.DataStoreRead_i[i];

    /* DataStoreRead: '<S86>/Data Store Read1' */
    t15_2_B.DataStoreRead1_m[i] = t15_2_DWork.volt[20 * i + 1];

    /* DataStoreRead: '<S89>/Data Store Read' */
    t15_2_B.DataStoreRead_c[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S89>/0.001' */
    t15_2_B.u01_b[i] = t15_2_P.u01_Gain_d * t15_2_B.DataStoreRead_c[i];
    ...
    /* Gain: '<S90>/0.001' */
    t15_2_B.u01_c[i] = t15_2_P.u01_Gain_k * t15_2_B.DataStoreRead_m[i];

    /* DataStoreRead: '<S90>/Data Store Read1' */
    t15_2_B.DataStoreRead1_fa[i] = t15_2_DWork.volt[20 * i + 3];

    /* DataStoreRead: '<S91>/Data Store Read' */
    t15_2_B.DataStoreRead_g[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S91>/0.001' */
    t15_2_B.u01_p[i] = t15_2_P.u01_Gain_i * t15_2_B.DataStoreRead_g[i];

    /* DataStoreRead: '<S91>/Data Store Read1' */
    t15_2_B.DataStoreRead1_d[i] = t15_2_DWork.volt[20 * i + 4];

    /* DataStoreRead: '<S92>/Data Store Read' */
    t15_2_B.DataStoreRead_m1[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S92>/0.001' */
    t15_2_B.u01_k[i] = t15_2_P.u01_Gain_m * t15_2_B.DataStoreRead_m1[i];

    /* DataStoreRead: '<S92>/Data Store Read1' */
    t15_2_B.DataStoreRead1_dl[i] = t15_2_DWork.volt[20 * i + 5];

    /* DataStoreRead: '<S93>/Data Store Read' */
    t15_2_B.DataStoreRead_pj[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S93>/0.001' */
    t15_2_B.u01_m[i] = t15_2_P.u01_Gain_p * t15_2_B.DataStoreRead_pj[i];

    /* DataStoreRead: '<S93>/Data Store Read1' */
    t15_2_B.DataStoreRead1_du[i] = t15_2_DWork.volt[20 * i + 6];

    /* DataStoreRead: '<S94>/Data Store Read' */
    t15_2_B.DataStoreRead_l[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S94>/0.001' */
    t15_2_B.u01_o[i] = t15_2_P.u01_Gain_g * t15_2_B.DataStoreRead_l[i];

    /* DataStoreRead: '<S94>/Data Store Read1' */
    t15_2_B.DataStoreRead1_mt[i] = t15_2_DWork.volt[20 * i + 7];

    /* DataStoreRead: '<S95>/Data Store Read' */
    t15_2_B.DataStoreRead_km[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S95>/0.001' */
    t15_2_B.u01_g[i] = t15_2_P.u01_Gain_n * t15_2_B.DataStoreRead_km[i];

    /* DataStoreRead: '<S95>/Data Store Read1' */
    t15_2_B.DataStoreRead1_p[i] = t15_2_DWork.volt[20 * i + 8];

    /* DataStoreRead: '<S96>/Data Store Read' */
    t15_2_B.DataStoreRead_mu[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S96>/0.001' */
    t15_2_B.u01_g3[i] = t15_2_P.u01_Gain_e * t15_2_B.DataStoreRead_mu[i];

    /* DataStoreRead: '<S96>/Data Store Read1' */
    t15_2_B.DataStoreRead1_f2[i] = t15_2_DWork.volt[20 * i + 9];

    /* DataStoreRead: '<S87>/Data Store Read' */
    t15_2_B.DataStoreRead_j[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S87>/0.001' */
    t15_2_B.u01_i[i] = t15_2_P.u01_Gain_p4 * t15_2_B.DataStoreRead_j[i];

    /* DataStoreRead: '<S87>/Data Store Read1' */
    t15_2_B.DataStoreRead1_h[i] = t15_2_DWork.volt[20 * i + 10];

    /* DataStoreRead: '<S88>/Data Store Read' */
    t15_2_B.DataStoreRead_b[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S88>/0.001' */
    t15_2_B.u01_mu[i] = t15_2_P.u01_Gain_mt * t15_2_B.DataStoreRead_b[i];

    /* DataStoreRead: '<S88>/Data Store Read1' */
    t15_2_B.DataStoreRead1_nn[i] = t15_2_DWork.volt[20 * i + 11];
  }
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1), &t15_2_B.DataStoreRead1_m[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_f), &t15_2_B.DataStoreRead1_l[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_n), &t15_2_B.DataStoreRead1_fa[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_j), &t15_2_B.DataStoreRead1_d[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_k), &t15_2_B.DataStoreRead1_dl[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_nb), &t15_2_B.DataStoreRead1_du[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_m), &t15_2_B.DataStoreRead1_mt[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_b), &t15_2_B.DataStoreRead1_p[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_mf), &t15_2_B.DataStoreRead1_f2[0],
                       t15_2_B.Times, &t15_2_B.u01_g3[0], 499U);
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_bd), &t15_2_B.DataStoreRead1_h[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_i), &t15_2_B.DataStoreRead1_nn[0],
                       t15_2_B.Times, &t15_2_B.u01_mu[0], 499U);

  /* Sum: '<S15>/Sum1' incorporates:
   *  Constant: '<S15>/1 '
   */
  t15_2_B.Sum1_k = t15_2_P._Value_c - t15_2_B.LogicalOperator1;

  /* Product: '<S15>/Divide7' */
  t15_2_B.Divide7[0] = t15_2_B.volt1 * t15_2_B.Sum1_k;
  t15_2_B.Divide7[1] = t15_2_B.volt1_f * t15_2_B.Sum1_k;
  t15_2_B.Divide7[2] = t15_2_B.volt1_n * t15_2_B.Sum1_k;
  t15_2_B.Divide7[3] = t15_2_B.volt1_j * t15_2_B.Sum1_k;
  t15_2_B.Divide7[4] = t15_2_B.volt1_k * t15_2_B.Sum1_k;
  t15_2_B.Divide7[5] = t15_2_B.volt1_nb * t15_2_B.Sum1_k;
  t15_2_B.Divide7[6] = t15_2_B.volt1_m * t15_2_B.Sum1_k;
  t15_2_B.Divide7[7] = t15_2_B.volt1_b * t15_2_B.Sum1_k;
  t15_2_B.Divide7[8] = t15_2_B.volt1_mf * t15_2_B.Sum1_k;
  t15_2_B.Divide7[9] = t15_2_B.volt1_bd * t15_2_B.Sum1_k;
  t15_2_B.Divide7[10] = t15_2_B.volt1_i * t15_2_B.Sum1_k;
  for (i = 0; i < 11; i++) {
    /* Sum: '<S15>/Sum3' */
    t15_2_B.Sum3[i] = ((t15_2_B.Divide4_g[i] + t15_2_B.Divide5_c[i]) +
                       t15_2_B.Divide5[i]) + t15_2_B.Divide7[i];

    /* Product: '<S53>/Divide2' */
    t15_2_B.Divide2_o[i] = t15_2_B.e6_h[i] * t15_2_B.Sum3[i];

    /* RelationalOperator: '<S71>/Compare' incorporates:
     *  Constant: '<S71>/Constant'
     */
    t15_2_B.Compare_a[i] = (uint8_T)(t15_2_B.Divide2_o[i] <
      t15_2_P.Constant_Value_p);

    /* Logic: '<S53>/Logical Operator' */
    t15_2_B.LogicalOperator_o[i] = ((t15_2_B.Compare[i] != 0) &&
      (t15_2_B.Compare_a[i] != 0));

    /* Switch: '<S53>/Switch' incorporates:
     *  Constant: '<S53>/1'
     */
    if (t15_2_B.LogicalOperator_o[i]) {
      t15_2_B.Switch[i] = t15_2_P._Value_g;
    } else {
  ...
  t15_2_B.DataStoreRead_bm = t15_2_DWork.RupRd[5];

  /* Gain: '<S82>/1.75' */
  t15_2_B.u5 = t15_2_P.u5_Gain * t15_2_B.DataStoreRead_bm;

  /* Product: '<S82>/Divide11' */
  t15_2_B.Divide11 = t15_2_B.UniformRandomNumber * t15_2_B.u5;

  /* UnitDelay: '<S83>/UD' */
  t15_2_B.Uk1_kx = t15_2_DWork.UD_DSTATE_c;

  /* Sum: '<S83>/Diff' */
  t15_2_B.Diff_c = t15_2_B.Times - t15_2_B.Uk1_kx;

  /* Gain: '<S82>/2e3' */
  t15_2_B.e3_p = t15_2_P.e3_Gain_it * t15_2_B.Diff_c;

  /* Sqrt: '<S82>/Sqrt' */
  t15_2_B.Sqrt = sqrt(t15_2_B.e3_p);

  /* Product: '<S82>/Divide1' */
  t15_2_B.Divide1_ap = t15_2_B.Divide11 / t15_2_B.Sqrt;

  /* Sum: '<S63>/Sum2' */
  t15_2_B.Sum2_h = t15_2_B.Divide1_ap + t15_2_B.Divide;

  /* DataStoreRead: '<S65>/Data Store Read' */
  t15_2_B.DataStoreRead_f = t15_2_DWork.t_tran2D;

  /* DataStoreRead: '<S65>/Data Store Read2' */
  t15_2_B.DataStoreRead2_pz = t15_2_DWork.tcont2;

  /* MinMax: '<S65>/MinMax' */
  u = t15_2_B.DataStoreRead_f;
  tmin = t15_2_B.DataStoreRead2_pz;
  if ((u >= tmin) || rtIsNaN(tmin)) {
    tmin = u;
  }

  t15_2_B.MinMax_h = tmin;

  /* End of MinMax: '<S65>/MinMax' */

  /* RelationalOperator: '<S65>/Relational Operator1' */
  t15_2_B.RelationalOperator1_o = (t15_2_B.Times > t15_2_B.MinMax_h);

  /* Product: '<S65>/Divide12' */
  t15_2_B.Divide12_p[0] = t15_2_B.Sum2_h * t15_2_B.RelationalOperator1_o;
  t15_2_B.Divide12_p[1] = t15_2_B.e6_h[11] * t15_2_B.RelationalOperator1_o;
  ...
  /* DiscreteStateSpace: '<S60>/VS. contr' */
  {
    ...
    t15_2_B.VScontr[0] += t15_2_P.VScontr_D*t15_2_B.Divide12_p[0];
   ...
   */
  t15_2_B.Compare_g = (t15_2_B.u_c < t15_2_P.Constant_Value_g);

  /* Product: '<S60>/Divide4' */
  t15_2_B.Divide4_gb[0] = (real_T)t15_2_B.Compare_g * t15_2_B.Divide12_p[0];
  t15_2_B.Divide4_gb[1] = (real_T)t15_2_B.Compare_g * t15_2_B.Divide12_p[1];
  ...
  /* DiscreteStateSpace: '<S60>/VS. contr hl' */
  {
    ...
    t15_2_B.VScontrhl[0] += t15_2_P.VScontrhl_D*t15_2_B.Divide4_gb[0];
    t15_2_B.VScontrhl[1] = 0.0;
  }

  /* Switch: '<S60>/c_eob' */
  if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold_bg) {
    t15_2_B.c_eob_kz[0] = t15_2_B.VScontr[0];
    t15_2_B.c_eob_kz[1] = t15_2_B.VScontr[1];
  } else {
    t15_2_B.c_eob_kz[0] = t15_2_B.VScontrhl[0];
    t15_2_B.c_eob_kz[1] = t15_2_B.VScontrhl[1];
  }

  /* End of Switch: '<S60>/c_eob' */

  /* DataStoreRead: '<S59>/Data Store Read1' */
  t15_2_B.DataStoreRead1_pd = t15_2_DWork.Ip_rd;

  /* RelationalOperator: '<S59>/Relational Operator2' */
  t15_2_B.RelationalOperator2_c = (t15_2_B.e6 < t15_2_B.DataStoreRead1_pd);

  /* DataStoreRead: '<S59>/Data Store Read' */
  t15_2_B.DataStoreRead_am = t15_2_DWork.RupRd[2];

  /* Abs: '<S59>/Abs' */
  t15_2_B.Abs_mv = fabs(t15_2_B.DataStoreRead_am);

  /* RelationalOperator: '<S59>/Relational Operator1' */
  t15_2_B.RelationalOperator1_h = (t15_2_B.e6 > t15_2_B.Abs_mv);

  /* RelationalOperator: '<S78>/Compare' incorporates:
   *  Constant: '<S78>/Constant'
   */
  t15_2_B.Compare_o = (t15_2_B.u_c < t15_2_P.Constant_Value_gf);

  /* Logic: '<S59>/Logical Operator1' */
  t15_2_B.LogicalOperator1_j = ((t15_2_B.RelationalOperator2_c != 0.0) &&
    (t15_2_B.RelationalOperator1_h != 0.0) && t15_2_B.Compare_o);

  /* DataStoreRead: '<S61>/Data Store Read' */
  t15_2_B.DataStoreRead_hk = t15_2_DWork.c_a_tpl1;

  /* Gain: '<S61>/1//15' */
  t15_2_B.u5_e = t15_2_P.u5_Gain_a * t15_2_B.DataStoreRead_hk;
   ...
   *  Switch: '<S15>/c_eob '
   */
  if (t15_2_B.LogicalOperator1_j >= t15_2_P._Threshold_jk) {
    /* Product: '<S15>/Divide6' */
     ...
     *  Constant: '<S15>/1'
     */
    t15_2_B.LowerRelop1_j = (t15_2_B.Divide6_k > t15_2_P._Value_f);

    /* Switch: '<S56>/Switch2' incorporates:
     *  Constant: '<S15>/1'
     */
    if (t15_2_B.LowerRelop1_j) {
      t15_2_B.Switch2_kp = t15_2_P._Value_f;
    } else {
      /* DataStoreRead: '<S15>/Data Store Read3' */
      t15_2_B.DataStoreRead3_n = t15_2_DWork.c_a_tpl_min;

      /* RelationalOperator: '<S56>/UpperRelop' */
      t15_2_B.UpperRelop_d = (t15_2_B.Divide6_k < t15_2_B.DataStoreRead3_n);

      /* Switch: '<S56>/Switch' */
      if (t15_2_B.UpperRelop_d) {
        t15_2_B.Switch_l = t15_2_B.DataStoreRead3_n;
      } else {
        t15_2_B.Switch_l = t15_2_B.Divide6_k;
      }
    ...
    t15_2_B.Divide11_c[0] = t15_2_B.Switch2_kp * t15_2_B.c_eob_kz[0];
    t15_2_B.Divide11_c[1] = t15_2_B.Switch2_kp * t15_2_B.c_eob_kz[1];
    t15_2_B.u_d[0] = t15_2_B.Divide11_c[0];
    t15_2_B.u_d[1] = t15_2_B.Divide11_c[1];
  } else {
    if (t15_2_B.u_c >= t15_2_P.c_eob_Threshold) {
      /* DataStoreRead: '<S61>/Data Store Read1' incorporates:
       *  Switch: '<S15>/c_eob '
       */
      t15_2_B.DataStoreRead1_ni = t15_2_DWork.Ip_div;

      /* RelationalOperator: '<S61>/Relational Operator2' incorporates:
       *  Switch: '<S15>/c_eob '
       */
      t15_2_B.RelationalOperator2_e = (t15_2_B.e6 > t15_2_B.DataStoreRead1_ni);

      /* Switch: '<S61>/Lim. Div. tr.' incorporates:
       *  Switch: '<S15>/c_eob '
       */
      if (t15_2_B.RelationalOperator2_e >= t15_2_P.LimDivtr_Threshold) {
        ...
        t15_2_B.DataStoreRead2_a = t15_2_DWork.max_VS_lim;

        /* RelationalOperator: '<S80>/LowerRelop1' */
        t15_2_B.LowerRelop1_l = (t15_2_B.Div > t15_2_B.DataStoreRead2_a);

        /* Switch: '<S80>/Switch2' */
        if (t15_2_B.LowerRelop1_l) {
          t15_2_B.Switch2_d = t15_2_B.DataStoreRead2_a;
        } else {
          /* RelationalOperator: '<S80>/UpperRelop' incorporates:
           *  Constant: '<S61>/1'
           */
          t15_2_B.UpperRelop_a = (t15_2_B.Div < t15_2_P._Value_m);

          /* Switch: '<S80>/Switch' incorporates:
           *  Constant: '<S61>/1'
           */
          if (t15_2_B.UpperRelop_a) {
            t15_2_B.Switch_j = t15_2_P._Value_m;
          } else {
            t15_2_B.Switch_j = t15_2_B.Div;
          }

          /* End of Switch: '<S80>/Switch' */
          t15_2_B.Switch2_d = t15_2_B.Switch_j;
        }

        /* End of Switch: '<S80>/Switch2' */
        t15_2_B.LimDivtr = t15_2_B.Switch2_d;
      }
       ...
       *  Switch: '<S15>/c_eob '
       */
      t15_2_B.Divide8[0] = t15_2_B.LimDivtr * t15_2_B.c_eob_kz[0];
      t15_2_B.Divide8[1] = t15_2_B.LimDivtr * t15_2_B.c_eob_kz[1];

      /* Switch: '<S15>/c_eob ' */
      t15_2_B.c_eob_mm[0] = t15_2_B.Divide8[0];
      t15_2_B.c_eob_mm[1] = t15_2_B.Divide8[1];
    } else {
       ...
       *  Switch: '<S15>/c_eob '
       */
      t15_2_B.LowerRelop1_d = (t15_2_B.Divide15 > t15_2_B.DataStoreRead4);

      /* Switch: '<S57>/Switch2' incorporates:
       *  Switch: '<S15>/c_eob '
       */
      if (t15_2_B.LowerRelop1_d) {
        t15_2_B.Switch2_i = t15_2_B.DataStoreRead4;
      } else {
        /* RelationalOperator: '<S57>/UpperRelop' incorporates:
         *  Constant: '<S15>/2'
         */
        t15_2_B.UpperRelop_j = (t15_2_B.Divide15 < t15_2_P._Value_o);

        /* Switch: '<S57>/Switch' incorporates:
         *  Constant: '<S15>/2'
         */
        if (t15_2_B.UpperRelop_j) {
          t15_2_B.Switch_b = t15_2_P._Value_o;
        } else {
          t15_2_B.Switch_b = t15_2_B.Divide15;
        }

        /* End of Switch: '<S57>/Switch' */
        t15_2_B.Switch2_i = t15_2_B.Switch_b;
      }
       ...
       *  Switch: '<S15>/c_eob '
       */
      t15_2_B.Divide_d[0] = t15_2_B.c_eob_kz[0] * t15_2_B.Switch2_i;
      t15_2_B.Divide_d[1] = t15_2_B.c_eob_kz[1] * t15_2_B.Switch2_i;

      /* Switch: '<S15>/c_eob ' */
      t15_2_B.c_eob_mm[0] = t15_2_B.Divide_d[0];
      t15_2_B.c_eob_mm[1] = t15_2_B.Divide_d[1];
    }

    t15_2_B.u_d[0] = t15_2_B.c_eob_mm[0];
    t15_2_B.u_d[1] = t15_2_B.c_eob_mm[1];
  }

  /* End of Switch: '<S59>/1' */

  /* Product: '<S15>/Divide10' */
  t15_2_B.Divide10[0] = t15_2_B.Sum1_k * t15_2_B.u_d[0];
  t15_2_B.Divide10[1] = t15_2_B.Sum1_k * t15_2_B.u_d[1];
  for (i = 0; i < 20; i++) {
    ...
    t15_2_B.Divide12_d[i] = t15_2_B.G_curr_term[i] * t15_2_B.LogicalOperator1;

    /* Product: '<S15>/Divide2' */
    t15_2_B.Divide2_b[i] = t15_2_B.LogicalOperator1 * t15_2_B.u_g[i];
  ...
  t15_2_B.DataStoreRead_al = t15_2_DWork.ref_ramp;
  for (i = 0; i < 11; i++) {
    /* Product: '<S55>/Divide1' */
    t15_2_B.Divide1_az[i] = t15_2_B.u_g[i + 8] / t15_2_B.DataStoreRead2_p[i];

    /* Gain: '<S55>/1e6' */
    t15_2_B.e6_j[i] = t15_2_P.e6_Gain_n * t15_2_B.Divide1_az[i];

    /* DataStoreRead: '<S5>/Data Store Read2' */
    t15_2_B.DataStoreRead2_d[i] = t15_2_DWork.ntur[i];

    /* Product: '<S5>/Divide4' */
    t15_2_B.Divide4_n[i] = t15_2_B.DataStoreRead2_d[i] * t15_2_B.Divide6_j[i];
  }
  ...
  /* UnitDelay: '<S6>/UD' */
  t15_2_B.Uk1_c = t15_2_DWork.UD_DSTATE_g;

  /* Sum: '<S6>/Diff' */
  t15_2_B.Diff_o = t15_2_B.Times - t15_2_B.Uk1_c;
  for (i = 0; i < 11; i++) {
    ...
    t15_2_B.DataStoreRead1_c[i] = t15_2_DWork.Vcspf_up[i];

    /* Memory: '<S7>/Memory1' */
    t15_2_B.Memory1_c[i] = t15_2_DWork.Memory1_PreviousInput_cd[i];

    /* DataStoreRead: '<S8>/Data Store Read1' */
    t15_2_B.DataStoreRead1_jk[i] = t15_2_DWork.Vcspf_up[i];

    /* Gain: '<S8>/2' */
    t15_2_B.u_dr[i] = t15_2_P._Gain * t15_2_B.DataStoreRead1_jk[i];

    /* Product: '<S8>/Divide1' */
    t15_2_B.Divide1_an[i] = t15_2_B.u_dr[i] / t15_2_B.DataStoreRead3;

    /* Sum: '<S7>/Add1' */
    t15_2_B.Add1_k[i] = t15_2_B.Divide4_n[i] - t15_2_B.Memory1_c[i];

    /* Product: '<S7>/Divide' */
    t15_2_B.Divide_m[i] = t15_2_B.Add1_k[i] / t15_2_B.Diff_o;

    /* RelationalOperator: '<S10>/LowerRelop1' */
    t15_2_B.LowerRelop1[i] = (t15_2_B.Divide_m[i] > t15_2_B.Divide1_an[i]);

    /* Gain: '<S8>/-1' */
    t15_2_B.u_gh[i] = t15_2_P.u_Gain_p * t15_2_B.Divide1_an[i];

    /* RelationalOperator: '<S10>/UpperRelop' */
    t15_2_B.UpperRelop[i] = (t15_2_B.Divide_m[i] < t15_2_B.u_gh[i]);

    /* Switch: '<S10>/Switch' */
    if (t15_2_B.UpperRelop[i]) {
      t15_2_B.Switch_h[i] = t15_2_B.u_gh[i];
    } else {
      t15_2_B.Switch_h[i] = t15_2_B.Divide_m[i];
    }
    ...
    if (t15_2_B.LowerRelop1[i]) {
      t15_2_B.Switch2[i] = t15_2_B.Divide1_an[i];
    } else {
      t15_2_B.Switch2[i] = t15_2_B.Switch_h[i];
    }

    /* End of Switch: '<S10>/Switch2' */

    /* Product: '<S7>/Divide1' */
    t15_2_B.Divide1_b[i] = t15_2_B.Switch2[i] * t15_2_B.Diff_o;

    /* Sum: '<S7>/Add2' */
    t15_2_B.Add2_l[i] = t15_2_B.Memory1_c[i] + t15_2_B.Divide1_b[i];

    /* RelationalOperator: '<S11>/LowerRelop1' */
    t15_2_B.LowerRelop1_b[i] = (t15_2_B.Add2_l[i] > t15_2_B.DataStoreRead1_c[i]);

    /* Gain: '<S9>/Gain' */
    t15_2_B.Gain[i] = t15_2_P.Gain_Gain_e * t15_2_B.DataStoreRead1_c[i];

    /* RelationalOperator: '<S11>/UpperRelop' */
    t15_2_B.UpperRelop_g[i] = (t15_2_B.Add2_l[i] < t15_2_B.Gain[i]);

    /* Switch: '<S11>/Switch' */
    if (t15_2_B.UpperRelop_g[i]) {
      t15_2_B.Switch_hr[i] = t15_2_B.Gain[i];
    } else {
      t15_2_B.Switch_hr[i] = t15_2_B.Add2_l[i];
    }

    /* End of Switch: '<S11>/Switch' */

    /* Switch: '<S11>/Switch2' */
    if (t15_2_B.LowerRelop1_b[i]) {
      t15_2_B.Switch2_a[i] = t15_2_B.DataStoreRead1_c[i];
    } else {
      t15_2_B.Switch2_a[i] = t15_2_B.Switch_hr[i];
    }
    ...
    /* Product: '<S2>/Divide3' */
    t15_2_B.Divide3_e[i] = t15_2_B.Switch2_a[i] / t15_2_B.DataStoreRead2_c[i];
  ...
  t15_2_B.DataStoreRead1_a = t15_2_DWork.VS1_up;

  /* RelationalOperator: '<S12>/LowerRelop1' */
  t15_2_B.LowerRelop1_a = (t15_2_B.Divide10[0] > t15_2_B.DataStoreRead1_a);

  /* Switch: '<S12>/Switch2' */
  if (t15_2_B.LowerRelop1_a) {
    t15_2_B.Switch2_e = t15_2_B.DataStoreRead1_a;
  } else {
    /* Gain: '<S4>/Gain' */
    t15_2_B.Gain_b = t15_2_P.Gain_Gain * t15_2_B.DataStoreRead1_a;

    /* RelationalOperator: '<S12>/UpperRelop' */
    t15_2_B.UpperRelop_l = (t15_2_B.Divide10[0] < t15_2_B.Gain_b);

    /* Switch: '<S12>/Switch' */
    if (t15_2_B.UpperRelop_l) {
      t15_2_B.Switch_mw = t15_2_B.Gain_b;
    } else {
      t15_2_B.Switch_mw = t15_2_B.Divide10[0];
    }

    /* End of Switch: '<S12>/Switch' */
    t15_2_B.Switch2_e = t15_2_B.Switch_mw;
  }
  ...
  for (i = 0; i < 11; i++) {
    ...
    /* Sum: '<S2>/Add1' */
    t15_2_B.Add1_b0[i] = t15_2_B.Divide3_e[i] + t15_2_B.Divide2_f[i];
  }
  ...
  t15_2_B.DataStoreRead3_b = t15_2_DWork.VS3_up;

  /* RelationalOperator: '<S13>/LowerRelop1' */
  t15_2_B.LowerRelop1_i = (t15_2_B.Divide10[1] > t15_2_B.DataStoreRead3_b);

  /* Switch: '<S13>/Switch2' */
  if (t15_2_B.LowerRelop1_i) {
    t15_2_B.Switch2_k = t15_2_B.DataStoreRead3_b;
  } else {
    /* Gain: '<S4>/Gain1' */
    t15_2_B.Gain1 = t15_2_P.Gain1_Gain * t15_2_B.DataStoreRead3_b;

    /* RelationalOperator: '<S13>/UpperRelop' */
    t15_2_B.UpperRelop_k = (t15_2_B.Divide10[1] < t15_2_B.Gain1);

    /* Switch: '<S13>/Switch' */
    if (t15_2_B.UpperRelop_k) {
      t15_2_B.Switch_o = t15_2_B.Gain1;
    } else {
      t15_2_B.Switch_o = t15_2_B.Divide10[1];
    }

    /* End of Switch: '<S13>/Switch' */
    t15_2_B.Switch2_k = t15_2_B.Switch_o;
  }

  /* End of Switch: '<S13>/Switch2' */

  /* Product: '<S2>/Divide5' */
  t15_2_B.Divide5_o = t15_2_B.Divide4_f * t15_2_B.Switch2_k;

  /* SignalConversion: '<S2>/TmpSignal ConversionAtnpf,12Inport1' */
  memcpy(&t15_2_B.TmpSignalConversionAtnpf12Inpor[0], &t15_2_B.Add1_b0[0], 11U *
         sizeof(real_T));
  ...
  for (i = 0; i < 11; i++) {
    ...
    t15_2_DWork.Memory1_PreviousInput_i3[i] = t15_2_B.switch1_h[i];

    /* Update for Memory: '<S66>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_c[i] = t15_2_B.u_o[i];

    /* Update for Memory: '<S58>/Memory' */
    t15_2_DWork.Memory_PreviousInput_c[i] = t15_2_B.u_e[i];

    /* Update for Memory: '<S7>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_cd[i] = t15_2_B.Switch2_a[i];
  }
  ...
  t15_2_DWork.Memory1_PreviousInput_d = t15_2_B.c_eob;

  /* Update for Memory: '<S44>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_m = t15_2_B.c_eob1;

  /* Update for Memory: '<S44>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_i = t15_2_B.c_eob_n;

  /* Update for Memory: '<S40>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_mc = t15_2_B.c_eob1_j;

  /* Update for Memory: '<S40>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_g = t15_2_B.c_eob_a;

  /* Update for Memory: '<S41>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_a = t15_2_B.c_eob1_jl;

  /* Update for Memory: '<S41>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_l = t15_2_B.c_eob_p;

  /* Update for Memory: '<S42>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_b = t15_2_B.c_eob1_g;

  /* Update for Memory: '<S42>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_h = t15_2_B.c_eob_jm;

  /* Update for Memory: '<S45>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_f = t15_2_B.c_eob1_i;

  /* Update for Memory: '<S45>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_f = t15_2_B.c_eob_h;

  /* Update for Memory: '<S43>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_j = t15_2_B.c_eob1_a;

  /* Update for Memory: '<S43>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_k = t15_2_B.c_eob_ck;

  /* Update for Memory: '<S29>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_e = t15_2_B.c_eob_na;

  /* Update for Memory: '<S32>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_ad = t15_2_B.c_eob_b;

  /* Update for Memory: '<S33>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_mc4 = t15_2_B.c_eob_e;

  /* Update for Memory: '<S34>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_d = t15_2_B.c_eob_m;

  /* Update for Memory: '<S35>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_i = t15_2_B.c_eob_ay;

  /* Update for Memory: '<S36>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_eq = t15_2_B.c_eob_b4;

  /* Update for Memory: '<S37>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_br = t15_2_B.c_eob_g;

  /* Update for Memory: '<S38>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_n = t15_2_B.c_eob_b2;

  /* Update for Memory: '<S39>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_c = t15_2_B.c_eob_gg;

  /* Update for Memory: '<S30>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_jn = t15_2_B.c_eob_en;

  /* Update for Memory: '<S31>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_nq = t15_2_B.c_eob_ev;

  /* Update for Memory: '<S25>/Memory' */
  t15_2_DWork.Memory_PreviousInput_i = t15_2_B.LogicalOperator_h;
  ...
  /* Update for DiscreteStateSpace: '<S55>/Lim. contr.' */
  {
    ...
    xnew[28] += (t15_2_P.Limcontr_B[343])*t15_2_B.Divide12_f[5];
    ...
    xnew[29] += (t15_2_P.Limcontr_B[344])*t15_2_B.Divide12_f[5];
    ...
    xnew[30] += (t15_2_P.Limcontr_B[345])*t15_2_B.Divide12_f[5];
    ...
    xnew[31] += (t15_2_P.Limcontr_B[346])*t15_2_B.Divide12_f[5];
    ...
    xnew[32] += (t15_2_P.Limcontr_B[347])*t15_2_B.Divide12_f[5];
    ...
    xnew[33] += (t15_2_P.Limcontr_B[348])*t15_2_B.Divide12_f[5];
    ...
    xnew[34] += (t15_2_P.Limcontr_B[349])*t15_2_B.Divide12_f[5];
    ...
    xnew[35] += (t15_2_P.Limcontr_B[350])*t15_2_B.Divide12_f[5];
    ...
    xnew[36] += (t15_2_P.Limcontr_B[351])*t15_2_B.Divide12_f[5];
    ...
    xnew[37] += (t15_2_P.Limcontr_B[352])*t15_2_B.Divide12_f[5];
    ...
    xnew[38] += (t15_2_P.Limcontr_B[353])*t15_2_B.Divide12_f[5];
    ...
    xnew[39] += (t15_2_P.Limcontr_B[354])*t15_2_B.Divide12_f[5];
    ...
    xnew[40] += (t15_2_P.Limcontr_B[355])*t15_2_B.Divide12_f[5];
    ...
    xnew[41] += (t15_2_P.Limcontr_B[356])*t15_2_B.Divide12_f[5];
    ...
    xnew[42] += (t15_2_P.Limcontr_B[357])*t15_2_B.Divide12_f[5];
    ...
    xnew[43] += (t15_2_P.Limcontr_B[358])*t15_2_B.Divide12_f[5];
    ...
    xnew[44] += (t15_2_P.Limcontr_B[359])*t15_2_B.Divide12_f[5];
    ...
    xnew[45] += (t15_2_P.Limcontr_B[360])*t15_2_B.Divide12_f[5];
    ...
    xnew[46] += (t15_2_P.Limcontr_B[361])*t15_2_B.Divide12_f[5];
    ...
    xnew[47] += (t15_2_P.Limcontr_B[362])*t15_2_B.Divide12_f[5];
    xnew[48] = (t15_2_P.Limcontr_A[913])*t15_2_DWork.Limcontr_DSTATE[48];
    xnew[48] += (t15_2_P.Limcontr_B[363])*t15_2_B.Divide12_f[5];
    xnew[49] = 0.0;
  ...
  t15_2_DWork.Memory1_PreviousInput_fx = t15_2_B.switch1_k;
  ...
  /* Update for DiscreteStateSpace: '<S15>/Curr. term. contr' */
  {
...

    {
      ...
      const real_T *u = &t15_2_B.Divide12_d[0];
      real_T *pxnew11 = &xnew[11];
      int_T numNonZero = 11;
      while (numNonZero--) {
        *pxnew11 += (*pB0++) * u[*pBidx++];
  ...
  /* Update for DiscreteStateSpace: '<S60>/VS. contr' */
  {
    ...
    xnew[0] += (t15_2_P.VScontr_B[0])*t15_2_B.Divide12_p[0];
    ...
    xnew[1] += (t15_2_P.VScontr_B[1])*t15_2_B.Divide12_p[0];
    ...
    xnew[2] += (t15_2_P.VScontr_B[2])*t15_2_B.Divide12_p[0];
    ...
    xnew[3] += (t15_2_P.VScontr_B[3])*t15_2_B.Divide12_p[0];
    xnew[4] = (t15_2_P.VScontr_A[20])*t15_2_DWork.VScontr_DSTATE[4];
    xnew[4] += (t15_2_P.VScontr_B[4])*t15_2_B.Divide12_p[0];
  ...
  /* Update for DiscreteStateSpace: '<S60>/VS. contr hl' */
  {
    ...
    xnew[0] += (t15_2_P.VScontrhl_B[0])*t15_2_B.Divide4_gb[0];
    ...
    xnew[1] += (t15_2_P.VScontrhl_B[1])*t15_2_B.Divide4_gb[0];
    ...
    xnew[2] += (t15_2_P.VScontrhl_B[2])*t15_2_B.Divide4_gb[0];
    ...
    xnew[3] += (t15_2_P.VScontrhl_B[3])*t15_2_B.Divide4_gb[0];
    xnew[4] = (t15_2_P.VScontrhl_A[20])*t15_2_DWork.VScontrhl_DSTATE[4];
    xnew[4] += (t15_2_P.VScontrhl_B[4])*t15_2_B.Divide4_gb[0];
...
void t15_2_initialize(void)
{
...

  {
    ...
    for (i = 0; i < 100; i++) {
      t15_2_B.SFunction1_ol[i] = 0.0;
    }

    for (i = 0; i < 100; i++) {
      t15_2_B.SFunction1_mh[i] = 0.0;
    }
    ...
    for (i = 0; i < 100; i++) {
      t15_2_B.SFunction1_ev[i] = 0.0;
    }

    for (i = 0; i < 100; i++) {
      t15_2_B.SFunction1_dk[i] = 0.0;
    }

    for (i = 0; i < 100; i++) {
      t15_2_B.SFunction1_l0[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.Memory1_e[i] = 0.0;
    }

    for (i = 0; i < 20; i++) {
      t15_2_B.Divide12_f[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_fa[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_m1[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_dl[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_pj[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_du[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_mt[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_km[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_mu[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.u01_g3[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.u01_mu[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_nn[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.Memory1_c[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.DataStoreRead1_jk[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.Switch_hr[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.Switch2_a[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.Divide3_a[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.Divide1_hq[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.Sum2_j[i] = 0.0;
    }
    ...
    for (i = 0; i < 50; i++) {
      t15_2_B.Add2_f5[i] = 0.0;
    }

    for (i = 0; i < 50; i++) {
      t15_2_B.Selector_om[i] = 0.0;
    }
    ...
    for (i = 0; i < 50; i++) {
      t15_2_B.Selector1_pp[i] = 0.0;
    }

    for (i = 0; i < 49; i++) {
      t15_2_B.Selector_n4[i] = 0.0;
    }
    ...
    for (i = 0; i < 50; i++) {
      t15_2_B.Divide6_nx[i] = 0.0;
    }

    for (i = 0; i < 50; i++) {
      t15_2_B.Add2_iy[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_eh[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_o2[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_ds[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_bv[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_bp[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_n1[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_fe[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_f4[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_oi[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_n2[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_di[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_fy[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_g5[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_dn[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_gs[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_hb[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_ez[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_dn5[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_ow[i] = 0.0;
    }
    ...
    t15_2_B.Memory2_ao = 0.0;
    t15_2_B.c_eob1_jl = 0.0;
    t15_2_B.Memory1_f = 0.0;
    t15_2_B.c_eob_p = 0.0;
    t15_2_B.c_eob_nz = 0.0;
    t15_2_B.Add3 = 0.0;
    t15_2_B.Divide2 = 0.0;
    t15_2_B.Memory2_j = 0.0;
    t15_2_B.c_eob1_g = 0.0;
    t15_2_B.Memory1_m = 0.0;
    t15_2_B.c_eob_jm = 0.0;
    t15_2_B.c_eob_k = 0.0;
    t15_2_B.Add4 = 0.0;
    ...
    t15_2_B.Memory2_jv = 0.0;
    t15_2_B.c_eob1_i = 0.0;
    t15_2_B.Memory1_fu = 0.0;
    t15_2_B.c_eob_h = 0.0;
    t15_2_B.c_eob_i = 0.0;
    t15_2_B.Add5 = 0.0;
    t15_2_B.Memory2_b = 0.0;
    t15_2_B.c_eob1_a = 0.0;
    t15_2_B.Memory1_n = 0.0;
    t15_2_B.c_eob_ck = 0.0;
    t15_2_B.c_eob_h4 = 0.0;
    t15_2_B.Add6 = 0.0;
    t15_2_B.Divide1 = 0.0;
    t15_2_B.Memory2_o = 0.0;
    t15_2_B.c_eob_na = 0.0;
    ...
    t15_2_B.Divide1_d1 = 0.0;
    t15_2_B.Add5_b = 0.0;
    t15_2_B.Memory2_or = 0.0;
    t15_2_B.c_eob_b4 = 0.0;
    t15_2_B.Divide1_fe = 0.0;
    t15_2_B.Add6_k = 0.0;
    t15_2_B.Memory2_mv = 0.0;
    t15_2_B.c_eob_g = 0.0;
    t15_2_B.Divide1_l = 0.0;
    t15_2_B.Add7 = 0.0;
    t15_2_B.Memory2_j0 = 0.0;
    t15_2_B.c_eob_b2 = 0.0;
    t15_2_B.Divide1_lo = 0.0;
    t15_2_B.Add8 = 0.0;
    t15_2_B.Memory2_ke = 0.0;
    t15_2_B.c_eob_gg = 0.0;
    t15_2_B.Divide1_h = 0.0;
    t15_2_B.Add9 = 0.0;
    t15_2_B.Memory2_c = 0.0;
    t15_2_B.c_eob_en = 0.0;
    t15_2_B.Divide1_k = 0.0;
    t15_2_B.Add10 = 0.0;
    t15_2_B.Memory2_p = 0.0;
    t15_2_B.c_eob_ev = 0.0;
    t15_2_B.Divide1_lf = 0.0;
    t15_2_B.Add11 = 0.0;
    ...
    t15_2_B.volt1_j = 0.0;
    t15_2_B.volt1_k = 0.0;
    t15_2_B.volt1_nb = 0.0;
    t15_2_B.volt1_m = 0.0;
    t15_2_B.volt1_b = 0.0;
    t15_2_B.volt1_mf = 0.0;
    t15_2_B.volt1_bd = 0.0;
    t15_2_B.volt1_i = 0.0;
    t15_2_B.Sum1_k = 0.0;
    t15_2_B.UniformRandomNumber = 0.0;
    t15_2_B.DataStoreRead_bm = 0.0;
    t15_2_B.u5 = 0.0;
    ...
    t15_2_B.DataStoreRead2_pz = 0.0;
    t15_2_B.MinMax_h = 0.0;
    t15_2_B.RelationalOperator1_o = 0.0;
    t15_2_B.Divide12_p[0] = 0.0;
    t15_2_B.Divide12_p[1] = 0.0;
    t15_2_B.VScontr[0] = 0.0;
    t15_2_B.VScontr[1] = 0.0;
    t15_2_B.Divide4_gb[0] = 0.0;
    t15_2_B.Divide4_gb[1] = 0.0;
    t15_2_B.VScontrhl[0] = 0.0;
    t15_2_B.VScontrhl[1] = 0.0;
    t15_2_B.c_eob_kz[0] = 0.0;
    t15_2_B.c_eob_kz[1] = 0.0;
    t15_2_B.DataStoreRead1_pd = 0.0;
    t15_2_B.RelationalOperator2_c = 0.0;
    t15_2_B.DataStoreRead_am = 0.0;
    t15_2_B.Abs_mv = 0.0;
    t15_2_B.RelationalOperator1_h = 0.0;
    t15_2_B.LogicalOperator1_j = 0.0;
    t15_2_B.DataStoreRead_hk = 0.0;
    t15_2_B.u5_e = 0.0;
    t15_2_B.Div = 0.0;
    t15_2_B.u_d[0] = 0.0;
    t15_2_B.u_d[1] = 0.0;
    ...
    t15_2_B.DataStoreRead_l5 = 0.0;
    t15_2_B.DataStoreRead1_i = 0.0;
    t15_2_B.DataStoreRead_ak = 0.0;
    t15_2_B.Subtract3_i = 0.0;
    t15_2_B.Divide2_c = 0.0;
    t15_2_B.Saturation1_a = 0.0;
    t15_2_B.DataStoreRead2_pa = 0.0;
    t15_2_B.u15_j = 0.0;
    t15_2_B.Divide9 = 0.0;
    t15_2_B.Saturation_j = 0.0;
    t15_2_B.DataStoreRead2_lw = 0.0;
    t15_2_B.Sum3_d = 0.0;
    t15_2_B.DataStoreRead4_o = 0.0;
    t15_2_B.DataStoreRead3_m = 0.0;
    t15_2_B.Sum2_hd = 0.0;
    t15_2_B.Divide1_m = 0.0;
    t15_2_B.Divide6_k1 = 0.0;
    t15_2_B.Sum = 0.0;
    t15_2_B.Divide2_p = 0.0;
    t15_2_B.Sum1_n = 0.0;
    t15_2_B.Switch2_g = 0.0;
    t15_2_B.Switch_m = 0.0;
    t15_2_B.DataStoreRead1_b = 0.0;
    t15_2_B.DataStoreRead_pjy = 0.0;
    t15_2_B.g5_termref = 0.0;
    t15_2_B.g5ref = 0.0;
    t15_2_B.DataStoreRead1_ii = 0.0;
    t15_2_B.DataStoreRead_mr = 0.0;
    t15_2_B.g1_termref = 0.0;
    t15_2_B.g1ref = 0.0;
    t15_2_B.DataStoreRead1_iu = 0.0;
    t15_2_B.DataStoreRead_fs = 0.0;
    t15_2_B.g6_termref = 0.0;
    t15_2_B.g6ref = 0.0;
    t15_2_B.DataStoreRead1_cb = 0.0;
    t15_2_B.DataStoreRead_lw = 0.0;
    t15_2_B.g4_termref = 0.0;
    t15_2_B.g4ref = 0.0;
    t15_2_B.DataStoreRead1_pw = 0.0;
    t15_2_B.DataStoreRead_d = 0.0;
    t15_2_B.g3_termref = 0.0;
    t15_2_B.g3ref = 0.0;
    t15_2_B.DataStoreRead1_el = 0.0;
    t15_2_B.DataStoreRead_f0 = 0.0;
    ...
    t15_2_B.Divide_c[2] = 0.0;
    t15_2_B.Divide_c[3] = 0.0;
    t15_2_B.Gain1 = 0.0;
    t15_2_B.Switch_o = 0.0;
    t15_2_B.Gain_b = 0.0;
    t15_2_B.Switch_mw = 0.0;
  }
  ...
  t15_2_DWork.Memory2_PreviousInput_ad = 0.0;
  t15_2_DWork.Memory2_PreviousInput_mc4 = 0.0;
  ...
  t15_2_DWork.Memory2_PreviousInput_jn = 0.0;
  t15_2_DWork.Memory2_PreviousInput_nq = 0.0;
  t15_2_DWork.Memory_PreviousInput_i = 0.0;
  t15_2_DWork.Memory3_PreviousInput = 0.0;

  {
    int_T i;
    for (i = 0; i < 11; i++) {
      t15_2_DWork.Memory1_PreviousInput_i3[i] = 0.0;
    }
  }

  t15_2_DWork.Memory1_PreviousInput_iu = 0.0;
...

  {
    int_T i;
    for (i = 0; i < 11; i++) {
      t15_2_DWork.Memory_PreviousInput_c[i] = 0.0;
    }
  }

  t15_2_DWork.Memory1_PreviousInput_fx = 0.0;
...

  {
    int_T i;
    for (i = 0; i < 11; i++) {
      t15_2_DWork.Memory1_PreviousInput_cd[i] = 0.0;
    }
  }
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: t15_2/<S46>/S-Function1 (read_gaps_term) */
    {
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          _ssSetOutputPortNumDimensions(rts, 0, 2);
          ssSetOutputPortWidth(rts, 0, 100);
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction1_l4));
        }
      }
    ...
    /* Level2 S-Function Block: t15_2/<S47>/S-Function1 (read_gaps_term) */
    {
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsCount(rts, 1);
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)t15_2_P.SFunction1_P1_Size_hq);
      }
    ...
    /* Level2 S-Function Block: t15_2/<S42>/S-Function1 (read_gaps) */
    {
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          _ssSetOutputPortNumDimensions(rts, 0, 2);
          ssSetOutputPortWidth(rts, 0, 100);
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction1_ol));
        }
      }
    ...
    /* Level2 S-Function Block: t15_2/<S48>/S-Function1 (read_gaps_term) */
    {
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          _ssSetOutputPortNumDimensions(rts, 0, 2);
          ssSetOutputPortWidth(rts, 0, 100);
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction1_mh));
        }
      }
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsCount(rts, 1);
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)t15_2_P.SFunction1_P1_Size_h0);
      }
    ...
    /* Level2 S-Function Block: t15_2/<S45>/S-Function1 (read_gaps) */
    {
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsCount(rts, 1);
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)t15_2_P.SFunction1_P1_Size_o5);
      }
    ...
    /* Level2 S-Function Block: t15_2/<S51>/S-Function1 (read_gaps_term) */
    {
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          _ssSetOutputPortNumDimensions(rts, 0, 2);
          ssSetOutputPortWidth(rts, 0, 100);
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction1_ev));
        }
      }
    ...
    /* Level2 S-Function Block: t15_2/<S43>/S-Function1 (read_gaps) */
    {
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          _ssSetOutputPortNumDimensions(rts, 0, 2);
          ssSetOutputPortWidth(rts, 0, 100);
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction1_dk));
        }
      }
    ...
    /* Level2 S-Function Block: t15_2/<S49>/S-Function1 (read_gaps_term) */
    {
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          _ssSetOutputPortNumDimensions(rts, 0, 2);
          ssSetOutputPortWidth(rts, 0, 100);
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction1_l0));
        }
      }
...

  {
    ...
    t15_2_DWork.Memory2_PreviousInput_m = t15_2_P.Memory2_X0_k;

    /* InitializeConditions for Memory: '<S44>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_i = t15_2_P.Memory1_X0_k;

    /* InitializeConditions for Memory: '<S40>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_mc = t15_2_P.Memory2_X0_o;
    ...
    t15_2_DWork.Memory2_PreviousInput_a = t15_2_P.Memory2_X0_b;

    /* InitializeConditions for Memory: '<S41>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_l = t15_2_P.Memory1_X0_l;

    /* InitializeConditions for Memory: '<S42>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_b = t15_2_P.Memory2_X0_kt;

    /* InitializeConditions for Memory: '<S42>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_h = t15_2_P.Memory1_X0_fb;

    /* InitializeConditions for Memory: '<S45>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_f = t15_2_P.Memory2_X0_d;

    /* InitializeConditions for Memory: '<S45>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_f = t15_2_P.Memory1_X0_c2;

    /* InitializeConditions for Memory: '<S43>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_j = t15_2_P.Memory2_X0_b2;

    /* InitializeConditions for Memory: '<S43>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_k = t15_2_P.Memory1_X0_kx;

    /* InitializeConditions for Memory: '<S29>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_e = t15_2_P.Memory2_X0_n;

    /* InitializeConditions for Memory: '<S32>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_ad = t15_2_P.Memory2_X0_l;

    /* InitializeConditions for Memory: '<S33>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_mc4 = t15_2_P.Memory2_X0_nw;

    /* InitializeConditions for Memory: '<S34>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_d = t15_2_P.Memory2_X0_n4;

    /* InitializeConditions for Memory: '<S35>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_i = t15_2_P.Memory2_X0_i;

    /* InitializeConditions for Memory: '<S36>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_eq = t15_2_P.Memory2_X0_iw;

    /* InitializeConditions for Memory: '<S37>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_br = t15_2_P.Memory2_X0_p;

    /* InitializeConditions for Memory: '<S38>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_n = t15_2_P.Memory2_X0_kc;

    /* InitializeConditions for Memory: '<S39>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_c = t15_2_P.Memory2_X0_bx;

    /* InitializeConditions for Memory: '<S30>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_jn = t15_2_P.Memory2_X0_of;

    /* InitializeConditions for Memory: '<S31>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_nq = t15_2_P.Memory2_X0_m;

    /* InitializeConditions for Memory: '<S25>/Memory' */
    t15_2_DWork.Memory_PreviousInput_i = t15_2_P.Memory_X0_h;
    ...
    t15_2_DWork.UD_DSTATE_b = t15_2_P.UD_InitialCondition_k;
    ...
    t15_2_DWork.Memory1_PreviousInput_iu = t15_2_P.Memory1_X0_g;
    ...
    t15_2_DWork.Memory1_PreviousInput_fx = t15_2_P.Memory1_X0_o;
    ...
    t15_2_DWork.UD_DSTATE_c = t15_2_P.UD_InitialCondition_n;
    ...
    for (i = 0; i < 11; i++) {
      ...
      t15_2_DWork.Memory1_PreviousInput_i3[i] = t15_2_P.Memory1_X0_i;

      /* InitializeConditions for Memory: '<S66>/Memory1' */
      t15_2_DWork.Memory1_PreviousInput_c[i] = t15_2_P.Memory1_X0_a;

      /* InitializeConditions for Memory: '<S58>/Memory' */
      t15_2_DWork.Memory_PreviousInput_c[i] = t15_2_P.Memory_X0_o;

      /* InitializeConditions for Memory: '<S7>/Memory1' */
      t15_2_DWork.Memory1_PreviousInput_cd[i] = t15_2_P.Memory1_X0_n;
    }

    /* InitializeConditions for UnitDelay: '<S6>/UD' */
    t15_2_DWork.UD_DSTATE_g = t15_2_P.UD_InitialCondition_p;
  }
}
