...
#define S_FUNCTION_NAME read_gaps_term
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define NPARAMS              1
/* Parameter  1 */
#define PARAMETER_0_NAME      n_gaps
...
extern void read_gaps_term_Outputs_wrapper(real_T *y0, 
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T  *n_gaps  = (const real_T *)mxGetData(PARAM_DEF0(S));

    read_gaps_term_Outputs_wrapper(y0, n_gaps, p_width0, S);
}
