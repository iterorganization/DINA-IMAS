 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Tue Feb 27 22:11:37 2018
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME pf_lookup3
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T  *n_pf  = (const real_T *)mxGetData(PARAM_DEF0(S));

    pf_lookup3_Outputs_wrapper(y0, n_pf, p_width0);
}
