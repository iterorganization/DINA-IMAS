...
class DINA_Workflow:
  ...
  def __init__(self, config):
    ...
    workflow.time_loop.component.resize(2)
    ...
    workflow.code.description = 'Workflow for simulation of VDE scenarios using DINA without magnetic controller' 



def main():
  
  parser = argparse.ArgumentParser(description='----DINA Workflow to simulate VDE')
